(function (self) {
    ...
    (function () {
        ...
        function parseJSFunc(r) {
            var e = r.toString().match(sourceRegex).slice(1);
    ...
    function setValue(e, r, i, t) {
        ...
        switch (i) {
            ...
            case "i64":
                (tempI64 = [
                    r >>> 0,
                    ((tempDouble = r), +Math_abs(tempDouble) >= +1 ? (tempDouble > +0 ? (Math_min(+Math_floor(tempDouble / +4294967296), +4294967295) | 0) >>> 0 : ~~+Math_ceil((tempDouble - +(~~tempDouble >>> 0)) / +4294967296) >>> 0) : 0),
                ]),
    ...
    function allocate(r, s, c, t) {
        ...
        if (c == ALLOC_NONE) {
            ...
            e = [_malloc, Runtime.stackAlloc, Runtime.staticAlloc, Runtime.dynamicAlloc][c === undefined ? ALLOC_STATIC : c](Math.max(n, u ? 1 : s.length));
        }
        if (l) {
            var t = e,
                f;
    ...
    function getMemory(e) {
        ...
        if ((typeof _sbrk !== "undefined" && !_sbrk.called) || !runtimeInitialized) return Runtime.dynamicAlloc(e);
        return _malloc(e);
    }
    ...
    __ATINIT__.push();
    memoryInitializer = "OggVorbisEncoder.min.js.mem";
    ...
    var IDBFS = {
        ...
        getLocalSet: function (t, n) {
            ...
            var e = FS.readdir(t.mountpoint).filter(a).map(s(t.mountpoint));
            while (e.length) {
                var r = e.pop();
                var i;
                try {
                ...
                if (FS.isDir(i.mode)) {
                    e.push.apply(e, FS.readdir(r).filter(a).map(s(r)));
                }
    ...
    var NODEFS = {
        ...
        node_ops: {
            getattr: function (i) {
                ...
                return { dev: e.dev, ino: e.ino, mode: e.mode, nlink: e.nlink, uid: e.uid, gid: e.gid, rdev: e.rdev, size: e.size, atime: e.atime, mtime: e.mtime, ctime: e.ctime, blksize: e.blksize, blocks: e.blocks };
            },
    ...
    var FS = {
        ...
        rename: function (r, t) {
            ...
            try {
                ...
                console.log("FS.trackingDelegate['willMovePath']('" + r + "', '" + t + "') threw an exception: " + l.message);
            }
            FS.hashRemoveNode(o);
            try {
            ...
            try {
                ...
                console.log("FS.trackingDelegate['onMovePath']('" + r + "', '" + t + "') threw an exception: " + l.message);
            }
        },
        rmdir: function (e) {
        ...
        open: function (r, e, t, u, f) {
            ...
            e &= ~(128 | 512);
            var n = FS.createStream({ node: i, path: FS.getPath(i), flags: e, seekable: true, position: 0, stream_ops: i.stream_ops, ungotten: [], error: false }, u, f);
            ...
            try {
                ...
                console.log("FS.trackingDelegate['onOpenFile']('" + r + "', flags) threw an exception: " + l.message);
            }
            return n;
        },
        close: function (e) {
        ...
        write: function (e, o, a, i, r, s) {
            ...
            try {
                ...
                console.log("FS.trackingDelegate['onWriteToFile']('" + path + "') threw an exception: " + f.message);
            }
            return n;
        },
        allocate: function (e, r, i) {
        ...
        createLazyFile: function (a, l, r, s, f) {
            ...
            t.prototype.cacheLength = function h() {
                ...
                e.open("HEAD", r, false);
                e.send(null);
                if (!((e.status >= 200 && e.status < 300) || e.status === 304)) throw new Error("Couldn't load " + r + ". Status: " + e.status);
    ...
    var Browser = {
        ...
        init: function () {
            ...
            i["handle"] = function a(i, t, o, a) {
                ...
                if (Browser.hasBlobConstructor) {
                    try {
                        ...
                        Runtime.warnOnce("Blob constructor present but fails: " + f + "; falling back to blob builder");
                    }
                }
                if (!r) {
            ...
            var e = Module["canvas"];
            function r() {
                Browser.pointerLock = document["pointerLockElement"] === e || document["mozPointerLockElement"] === e || document["webkitPointerLockElement"] === e || document["msPointerLockElement"] === e;
            }
            if (e) {
                e.requestPointerLock = e["requestPointerLock"] || e["mozRequestPointerLock"] || e["webkitRequestPointerLock"] || e["msRequestPointerLock"] || function () {};
                e.exitPointerLock = document["exitPointerLock"] || document["mozExitPointerLock"] || document["webkitExitPointerLock"] || document["msExitPointerLock"] || function () {};
        ...
        createContext: function (i, e, s, n) {
            ...
            if (!r) return null;
            if (s) {
                if (!e) assert(typeof GLctx === "undefined", "cannot set in module if GLctx is used, but we are a non-GL context that would replace it");
                Module.ctx = r;
        ...
        requestFullScreen: function (n, o, t) {
            ...
            function i() {
                ...
                if (
                    ...
                    e.cancelFullScreen = document["cancelFullScreen"] || document["mozCancelFullScreen"] || document["webkitCancelFullScreen"] || document["msExitFullscreen"] || document["exitFullscreen"] || function () {};
    ...
    function _floor0_exportbundle() {
        Module["printErr"]("missing function: floor0_exportbundle");
        abort(-1);
    }
    ...
    Module["createContext"] = function _(e, r, i, t) {
    ...
    function invoke_vi(r, i) {
        try {
            Module["dynCall_vi"](r, i);
        } catch (e) {
            if (typeof e !== "number" && e !== "longjmp") throw e;
            asm["setThrew"](1, 0);
        }
    ...
    function invoke_ii(r, i) {
        try {
            return Module["dynCall_ii"](r, i);
        } catch (e) {
            if (typeof e !== "number" && e !== "longjmp") throw e;
            asm["setThrew"](1, 0);
        }
    }
    function invoke_viii(r, i, t, n) {
        try {
            Module["dynCall_viii"](r, i, t, n);
        } catch (e) {
            if (typeof e !== "number" && e !== "longjmp") throw e;
            asm["setThrew"](1, 0);
        }
    }
    function invoke_iiiiiiiii(r, i, t, n, o, a, s, f, l) {
        try {
            return Module["dynCall_iiiiiiiii"](r, i, t, n, o, a, s, f, l);
        } catch (e) {
            if (typeof e !== "number" && e !== "longjmp") throw e;
            asm["setThrew"](1, 0);
        }
    ...
    function invoke_iiiiii(r, i, t, n, o, a) {
        try {
            return Module["dynCall_iiiiii"](r, i, t, n, o, a);
        } catch (e) {
            if (typeof e !== "number" && e !== "longjmp") throw e;
            asm["setThrew"](1, 0);
        }
    ...
    Module.asmLibraryArg = {
        ...
        ABORT: ABORT,
        cttz_i8: cttz_i8,
        _floor0_exportbundle: _floor0_exportbundle,
    };
    var asm = (function (v, c, P) {
        "use asm";
        var a = new v.Int8Array(P);
        var An = new v.Int16Array(P);
        var e = new v.Int32Array(P);
        var k = new v.Uint8Array(P);
        var yn = new v.Uint16Array(P);
        var bn = new v.Uint32Array(P);
        var r = new v.Float32Array(P);
        var t = new v.Float64Array(P);
        var i = c.STACKTOP | 0;
        var cr = c.STACK_MAX | 0;
        var p = c.tempDoublePtr | 0;
        var Sn = c.ABORT | 0;
        var te = c.cttz_i8 | 0;
        var _r = c._floor0_exportbundle | 0;
        var Re = 0;
        var Ki = 0;
        var Kt = 0;
        var Xt = 0;
        ...
        var L = c.abort;
        var It = c.assert;
        var xt = c.invoke_iiiii;
        var zt = c.invoke_vi;
        var qt = c.invoke_vii;
        var Zt = c.invoke_ii;
        var Jt = c.invoke_viii;
        var en = c.invoke_iiiiiiiii;
        var nn = c.invoke_iii;
        var on = c.invoke_iiiiii;
        var an = c._sin;
        var sn = c._exp;
        var fn = c._cosf;
        var ln = c.___setErrNo;
        var mn = c._floor;
        var kn = c._fflush;
        var Rn = c._llvm_sqrt_f64;
        var bt = c._llvm_pow_f64;
        var Fn = c._emscripten_set_main_loop_timing;
        var Mn = c._fabsf;
        var x = c._sbrk;
        var gn = c._atan;
        var hr = c._emscripten_memcpy_big;
        var vr = c._sysconf;
        var _n = c._sinf;
        var En = c._cos;
        var vn = c._log;
        var pn = c._emscripten_set_main_loop;
        var Fe = c.___errno_location;
        var wn = c.__exit;
        var o = c._abort;
        var Oe = c._time;
        var hn = c._ceil;
        ...
        function s(i, l, u) {
            ...
            do
                if (u >>> 0 <= 32) {
                    ...
                    if ((e[i >> 2] | 0) >= ((o + -4) | 0)) {
                        if (!r) return;
                        if ((o | 0) > 2147483391) break;
                        f = (i + 8) | 0;
                        r = M(e[f >> 2] | 0, (o + 256) | 0) | 0;
                        if (!r) break;
                        e[f >> 2] = r;
                        e[t >> 2] = (e[t >> 2] | 0) + 256;
                        r = (r + (e[i >> 2] | 0)) | 0;
                    ...
                    do
                        if (
                            (((t | 0) > 7 ? ((a[((e[s >> 2] | 0) + 1) >> 0] = f >>> ((8 - (e[o >> 2] | 0)) | 0)), (t | 0) > 15) : 0) ? ((a[((e[s >> 2] | 0) + 2) >> 0] = f >>> ((16 - (e[o >> 2] | 0)) | 0)), (t | 0) > 23) : 0)
                                ? ((a[((e[s >> 2] | 0) + 3) >> 0] = f >>> ((24 - (e[o >> 2] | 0)) | 0)), (t | 0) > 31)
                                : 0
                        ) {
                            r = e[o >> 2] | 0;
                            if (!r) {
        ...
        function me(i, r) {
            ...
            if ((n | 0) > 8) {
                ...
                if ((n | 0) > 16) {
                    ...
                    if ((n | 0) > 24) {
                        r = ((k[(i + 3) >> 0] | 0) << (24 - t)) | r;
                        if (!(((n | 0) < 33) | ((t | 0) == 0))) r = ((k[(i + 4) >> 0] | 0) << (32 - t)) | r;
                    }
                }
            }
            r = r & a;
                ...
                if (r >>> 0 > 32) {
                    ...
                    if ((o | 0) > 8) {
                        ...
                        if ((o | 0) > 16) {
                            ...
                            if ((o | 0) > 24) {
                                i = ((k[(a + 3) >> 0] | 0) << (24 - n)) | i;
                                if (!(((o | 0) < 33) | ((n | 0) == 0))) i = ((k[(a + 4) >> 0] | 0) << (32 - n)) | i;
                            }
                        }
                    }
                    n = ((o | 0) / 8) | 0;
        ...
        function _(r) {
            r = r | 0;
            return ((((((e[(r + 4) >> 2] | 0) + 7) | 0) / 8) | 0) + (e[r >> 2] | 0)) | 0;
        }
        function Te(r) {
            r = r | 0;
            return e[(r + 8) >> 2] | 0;
        ...
        function ft(r) {
            ...
            if ((n | 0) > 0) {
                ...
                t = 0;
                do {
                    i = e[(144 + (((k[(o + t) >> 0] | 0) ^ (i >>> 24)) << 2)) >> 2] ^ (i << 8);
                    t = (t + 1) | 0;
                } while ((t | 0) < (n | 0));
            } else i = 0;
            o = e[(r + 12) >> 2] | 0;
            if ((o | 0) > 0) {
                ...
                t = 0;
                do {
                    i = e[(144 + (((k[(n + t) >> 0] | 0) ^ (i >>> 24)) << 2)) >> 2] ^ (i << 8);
                    t = (t + 1) | 0;
                } while ((t | 0) < (o | 0));
            }
            a[((e[r >> 2] | 0) + 22) >> 0] = i;
        ...
        function lt(o, s, h, S, E, v) {
            ...
            if (m) {
                ...
                do {
                    c = (s + (i << 3) + 4) | 0;
                    d(((e[o >> 2] | 0) + a) | 0, e[(s + (i << 3)) >> 2] | 0, e[c >> 2] | 0) | 0;
                    a = ((e[u >> 2] | 0) + (e[c >> 2] | 0)) | 0;
                    e[u >> 2] = a;
                    i = (i + 1) | 0;
                } while ((i | 0) != (h | 0));
        ...
        function Q(n, r) {
            ...
            e[(t + 4) >> 2] = e[(r + 4) >> 2];
            a = (r + 16) | 0;
            r = lt(n, t, 1, e[(r + 12) >> 2] | 0, e[a >> 2] | 0, e[(a + 4) >> 2] | 0) | 0;
            i = o;
            return r | 0;
        }
        function De(e, r) {
        ...
        function Le(r, E, w, g) {
            ...
            e: do
                if (!n)
                    ...
                    while (1) {
                        ...
                        t = (i + 1) | 0;
                        if (((e[((e[o >> 2] | 0) + (i << 2)) >> 2] & 255) | 0) == 255) i = t;
                        else {
                            l = 0;
                            o = 0;
                            h = 0;
            ...
            l = i | 2;
            a[t >> 0] = n ? l : i;
            if (((e[(r + 328) >> 2] | 0) != 0) & ((S | 0) == (u | 0))) a[t >> 0] = (n ? l : i) | 4;
            e[c >> 2] = 1;
            a[(r + 46) >> 0] = g;
            a[(r + 47) >> 0] = v;
            a[(r + 48) >> 0] = _;
            ...
            c = (S - u) | 0;
            e[k >> 2] = c;
            B(o | 0, (o + (u << 2)) | 0, (c << 2) | 0) | 0;
            c = e[(r + 20) >> 2] | 0;
            B(c | 0, (c + (u << 3)) | 0, (e[k >> 2] << 3) | 0) | 0;
            e[n >> 2] = (e[n >> 2] | 0) + i;
            ft(E);
            n = 1;
            return n | 0;
        ...
        function wr(o, i) {
            ...
            a = e[(o + 8) >> 2] | 0;
            o = e[n >> 2] | 0;
            e[(i + 24) >> 2] = ((e[(n + 4) >> 2] | 0) / (o | 0)) | 0;
            e[i >> 2] = 1;
            f = +((o >> 1) | 0);
            s = +(a | 0);
            e[(i + 12) >> 2] = ~~+F((+(e[(n + 3360) >> 2] | 0) * f) / s);
            e[(i + 16) >> 2] = ~~+F((+(e[(n + 3364) >> 2] | 0) * f) / s);
            e[(i + 20) >> 2] = ~~+F((+(e[(n + 3368) >> 2] | 0) * f) / s);
            t[(i + 32) >> 3] = 7;
            r = ~~(+(r | 0) * +t[(n + 3376) >> 3]);
            e[(i + 8) >> 2] = r;
            e[(i + 4) >> 2] = r;
        ...
        function K(r) {
            r = r | 0;
            return ((e[((e[((e[(r + 64) >> 2] | 0) + 104) >> 2] | 0) + 80) >> 2] | 0) != 0) | 0;
        }
        function Er(l) {
            l = l | 0;
            var u = 0,
            ...
            if ((i | 0) > 0) {
                ...
                e: do
                    if ((i | 0) > (c | 0)) {
                        if (((u | 0) > (d | 0)) & ((r | 0) > 0) ? ((u - d + o) | 0) > (c | 0) : 0)
                            while (1) {
                                o = (r + -1) | 0;
                                i = (_(e[(w + 12 + (o << 2)) >> 2] | 0) | 0) << 3;
                                if (!(((i | 0) > (d | 0)) & ((r | 0) > 1))) {
                                    r = o;
                                    break e;
                                }
                                if (((i - d + (e[m >> 2] | 0)) | 0) > (c | 0)) r = o;
                                else {
                                    r = o;
                                    break;
                                }
                            }
                    } else if (((i | 0) < (c | 0) ? ((R = (r + 1) | 0), ((u | 0) < (d | 0)) & ((R | 0) < 15)) : 0) ? ((u - d + o) | 0) < (c | 0) : 0) {
                        r = R;
                        while (1) {
                            o = (_(e[(w + 12 + (r << 2)) >> 2] | 0) | 0) << 3;
                            i = (r + 1) | 0;
                            if (!(((o | 0) < (d | 0)) & ((i | 0) < 15))) break e;
                            if (((o - d + (e[m >> 2] | 0)) | 0) < (c | 0)) r = i;
                            else break;
                        }
                    }
                while (0);
            ...
            e: do
                if (((u | 0) < (h | 0)) & ((o | 0) > 0) ? ((k = (a + 88) | 0), ((u - h + (e[k >> 2] | 0)) | 0) < 0) : 0) {
                    o = r;
                    while (1) {
                        r = (o + 1) | 0;
                        if ((o | 0) > 13) break e;
                        u = (_(e[(w + 12 + (r << 2)) >> 2] | 0) | 0) << 3;
                        if (((u - h + (e[k >> 2] | 0)) | 0) < 0) o = r;
                        else break;
                    }
                }
            while (0);
            e: do
                if (((u | 0) > (n | 0)) & ((e[g >> 2] | 0) > 0) ? ((A = (a + 88) | 0), ((u - n + (e[A >> 2] | 0)) | 0) > (e[S >> 2] | 0)) : 0) {
                    o = r;
                    while (1) {
                        r = (o + -1) | 0;
                        if ((o | 0) < 1) break e;
                        u = (_(e[(w + 12 + (r << 2)) >> 2] | 0) | 0) << 3;
                        if (((u - n + (e[A >> 2] | 0)) | 0) > (e[S >> 2] | 0)) o = r;
                        else break;
                    }
                }
            while (0);
            if ((r | 0) < 0) {
                i = ((((e[S >> 2] | 0) + n - (e[(a + 88) >> 2] | 0)) | 0) / 8) | 0;
                e[(a + 124) >> 2] = 0;
                r = (w + 12) | 0;
                if ((_(e[r >> 2] | 0) | 0) > (i | 0)) {
                    Mi(e[r >> 2] | 0, i << 3);
            ...
            if (e[O >> 2] | 0) l = f(e[(a + 104) >> 2] | 0, l) | 0;
            n = (a + 84) | 0;
            e[n >> 2] = o - l + (e[n >> 2] | 0);
            n = 0;
            return n | 0;
        ...
        function Ce(r, i) {
            ...
            if (i) {
                if (!(e[((e[((e[(t + 64) >> 2] | 0) + 104) >> 2] | 0) + 80) >> 2] | 0)) r = 7;
                else r = e[(r + 124) >> 2] | 0;
                o = ((e[(t + 104) >> 2] | 0) + 12 + (r << 2)) | 0;
                e[i >> 2] = Te(e[o >> 2] | 0) | 0;
                e[(i + 4) >> 2] = _(e[o >> 2] | 0) | 0;
                e[(i + 8) >> 2] = 0;
                e[(i + 12) >> 2] = e[(t + 44) >> 2];
        ...
        function xe(a) {
            ...
            if (p) {
                ...
                t = e[s >> 2] | 0;
                if (t) {
                    if ((f | 0) != 0 ? ((l = (f + 16) | 0), (e[l >> 2] | 0) > 0) : 0) {
                        r = (f + 800) | 0;
                        R[e[((e[(25640 + (e[r >> 2] << 2)) >> 2] | 0) + 16) >> 2] & 7](e[t >> 2] | 0);
                        if ((e[l >> 2] | 0) > 1) {
                            i = 1;
                            do {
                                R[e[((e[(25640 + (e[(r + (i << 2)) >> 2] << 2)) >> 2] | 0) + 16) >> 2] & 7](e[((e[s >> 2] | 0) + (i << 2)) >> 2] | 0);
                                i = (i + 1) | 0;
                            } while ((i | 0) < (e[l >> 2] | 0));
                        }
                        t = e[s >> 2] | 0;
                ...
                t = e[r >> 2] | 0;
                if (t) {
                    if ((f | 0) != 0 ? ((h = (f + 20) | 0), (e[h >> 2] | 0) > 0) : 0) {
                        s = (f + 1312) | 0;
                        R[e[((e[(25648 + (e[s >> 2] << 2)) >> 2] | 0) + 16) >> 2] & 7](e[t >> 2] | 0);
                        if ((e[h >> 2] | 0) > 1) {
                            i = 1;
                            do {
                                R[e[((e[(25648 + (e[(s + (i << 2)) >> 2] << 2)) >> 2] | 0) + 16) >> 2] & 7](e[((e[r >> 2] | 0) + (i << 2)) >> 2] | 0);
                                i = (i + 1) | 0;
                            } while ((i | 0) < (e[h >> 2] | 0));
                        }
                        t = e[r >> 2] | 0;
            ...
            r = e[s >> 2] | 0;
            if (r) {
                if (m ? ((w = (d + 4) | 0), (u = e[w >> 2] | 0), (u | 0) > 0) : 0) {
                    t = 0;
                    while (1) {
                        r = e[(r + (t << 2)) >> 2] | 0;
                        if (r) {
        ...
        function He(a, s) {
            ...
            if (((r + s) | 0) >= (e[l >> 2] | 0)) {
                ...
                if ((e[s >> 2] | 0) > 0) {
                    t = (a + 8) | 0;
                    i = M(e[e[t >> 2] >> 2] | 0, r << 2) | 0;
                    e[e[t >> 2] >> 2] = i;
                    i = e[s >> 2] | 0;
                    if ((i | 0) > 1) {
                        r = 1;
                        do {
                            o = M(e[((e[t >> 2] | 0) + (r << 2)) >> 2] | 0, e[l >> 2] << 2) | 0;
                            e[((e[t >> 2] | 0) + (r << 2)) >> 2] = o;
                            r = (r + 1) | 0;
                            o = e[s >> 2] | 0;
                        } while ((r | 0) < (o | 0));
            ...
            if ((u | 0) == 11 ? (f | 0) > 0 : 0) {
                ...
                i = 0;
                do {
                    e[((e[t >> 2] | 0) + (i << 2)) >> 2] = (e[((e[r >> 2] | 0) + (i << 2)) >> 2] | 0) + (o << 2);
                    i = (i + 1) | 0;
                } while ((i | 0) < (f | 0));
                t = e[t >> 2] | 0;
                return t | 0;
        ...
        function Fr(t, r) {
            ...
            while (1) {
                if ((n | 0) > 64) {
                    t = e[l >> 2] | 0;
                    t = (n | 0) > (t | 0) ? t : n;
                    +je(((e[((e[r >> 2] | 0) + (o << 2)) >> 2] | 0) + ((n - t) << 2)) | 0, c, t, 32);
                    t = e[((e[r >> 2] | 0) + (o << 2)) >> 2] | 0;
                    n = e[f >> 2] | 0;
                    We(c, (t + ((n + -32) << 2)) | 0, 32, (t + (n << 2)) | 0, ((e[s >> 2] | 0) - n) | 0);
                } else w(((e[((e[r >> 2] | 0) + (o << 2)) >> 2] | 0) + (n << 2)) | 0, 0, (((e[s >> 2] | 0) - n) << 2) | 0) | 0;
                o = (o + 1) | 0;
                if ((o | 0) >= (e[u >> 2] | 0)) {
                    r = 0;
                    break;
        ...
        function Ue(c, t) {
            ...
            D = (c + 48) | 0;
            F = (c + 40) | 0;
            C = ((e[D >> 2] | 0) - (((e[(s + (e[F >> 2] << 2)) >> 2] | 0) / 2) | 0)) | 0;
            p = e[(t + 104) >> 2] | 0;
            if (!(e[(c + 28) >> 2] | 0)) {
                t = 0;
                return t | 0;
            ...
            while (0);
            w = e[(s + (i << 2)) >> 2] | 0;
            x = ((((e[(s + (e[F >> 2] << 2)) >> 2] | 0) / 4) | 0) + (e[D >> 2] | 0) + (((w | 0) / 4) | 0)) | 0;
            P = (c + 20) | 0;
            if ((e[P >> 2] | 0) < ((x + (((w | 0) / 2) | 0)) | 0)) {
                t = 0;
                return t | 0;
            }
            S = (t + 84) | 0;
            ...
            if (a) {
                f = (t + 68) | 0;
                w = (t + 76) | 0;
                e[f >> 2] = M(e[f >> 2] | 0, ((e[w >> 2] | 0) + a) | 0) | 0;
                e[w >> 2] = (e[w >> 2] | 0) + (e[E >> 2] | 0);
                e[E >> 2] = 0;
            }
            v = (t + 72) | 0;
            e[v >> 2] = 0;
            ...
            e: do
                if ((i | 0) > 0) {
                    ...
                    while (1) {
                        ...
                        e[v >> 2] = i + m;
                        e[((e[p >> 2] | 0) + (o << 2)) >> 2] = a + i;
                        d(e[((e[p >> 2] | 0) + (o << 2)) >> 2] | 0, e[((e[A >> 2] | 0) + (o << 2)) >> 2] | 0, h | 0) | 0;
                        e[((e[t >> 2] | 0) + (o << 2)) >> 2] = (e[((e[p >> 2] | 0) + (o << 2)) >> 2] | 0) + (C << 2);
                        o = (o + 1) | 0;
                        if ((o | 0) >= (e[b >> 2] | 0)) break e;
                        i = e[v >> 2] | 0;
                        _ = e[R >> 2] | 0;
                        a = e[O >> 2] | 0;
                    }
            ...
            i = ((e[P >> 2] | 0) - o) | 0;
            e[P >> 2] = i;
            if ((e[b >> 2] | 0) > 0 ? ((I = (c + 8) | 0), (t = e[e[I >> 2] >> 2] | 0), B(t | 0, (t + (o << 2)) | 0, (i << 2) | 0) | 0, (e[b >> 2] | 0) > 1) : 0) {
                i = 1;
                do {
                    t = e[((e[I >> 2] | 0) + (i << 2)) >> 2] | 0;
                    B(t | 0, (t + (o << 2)) | 0, (e[P >> 2] << 2) | 0) | 0;
                    i = (i + 1) | 0;
                } while ((i | 0) < (e[b >> 2] | 0));
            }
            e[w >> 2] = e[F >> 2];
            ...
            if (!i) {
                s = f;
                s = N(e[s >> 2] | 0, e[(s + 4) >> 2] | 0, o | 0, ((((o | 0) < 0) << 31) >> 31) | 0) | 0;
                t = f;
                e[t >> 2] = s;
                e[(t + 4) >> 2] = l;
                t = 1;
            ...
            if ((i | 0) > (a | 0)) {
                ...
                s = (i + o - a) | 0;
                t = f;
                s = N(e[t >> 2] | 0, e[(t + 4) >> 2] | 0, s | 0, ((((s | 0) < 0) << 31) >> 31) | 0) | 0;
                t = f;
                e[t >> 2] = s;
                e[(t + 4) >> 2] = l;
                t = 1;
        ...
        function Rr(f, m, s) {
            ...
            e[r >> 2] = h(1, 20) | 0;
            ve(n, e[o >> 2] >> i);
            ve(e[e[l >> 2] >> 2] | 0, e[d >> 2] >> i);
            e[(c + 4) >> 2] = (S(e[o >> 2] | 0) | 0) + -7;
            e[(c + 8) >> 2] = (S(e[d >> 2] | 0) | 0) + -7;
            e: do
                if (!s) {
                    l = (o + 2848) | 0;
                    if ((e[l >> 2] | 0) == 0 ? ((t = (o + 24) | 0), (e[l >> 2] = h(e[t >> 2] | 0, 56) | 0), (a = e[t >> 2] | 0), (a | 0) > 0) : 0) {
                        r = 0;
                        while (1) {
                            n = (o + 1824 + (r << 2)) | 0;
                            i = e[n >> 2] | 0;
                            if (!i) break;
                            if (tt(((e[l >> 2] | 0) + ((r * 56) | 0)) | 0, i) | 0) {
                                E = 20;
                                break;
                            }
                            fe(e[n >> 2] | 0);
                    ...
                    or((c + 32) | 0, e[d >> 2] | 0);
                    n = (o + 2848) | 0;
                    if (((e[n >> 2] | 0) == 0 ? ((w = (o + 24) | 0), (v = h(e[w >> 2] | 0, 56) | 0), (e[n >> 2] = v), (e[w >> 2] | 0) > 0) : 0) ? (nr(v, e[(o + 1824) >> 2] | 0) | 0, (e[w >> 2] | 0) > 1) : 0) {
                        i = 1;
                        do {
                            nr(((e[n >> 2] | 0) + ((i * 56) | 0)) | 0, e[(o + 1824 + (i << 2)) >> 2] | 0) | 0;
                            i = (i + 1) | 0;
                        } while ((i | 0) < (e[w >> 2] | 0));
                    }
                    r = (o + 28) | 0;
                    ...
                    r: do
                        if ((e[r >> 2] | 0) > 0) {
                            ...
                            while (1) {
                                t = e[(o + 2852 + (i << 2)) >> 2] | 0;
                                lr((n + ((i * 52) | 0)) | 0, t, a, ((e[(o + (e[t >> 2] << 2)) >> 2] | 0) / 2) | 0, e[l >> 2] | 0);
                                i = (i + 1) | 0;
                                if ((i | 0) >= (e[r >> 2] | 0)) break r;
                                n = e[s >> 2] | 0;
                            }
                        }
                    while (0);
            ...
            e[s >> 2] = r;
            e[(f + 12) >> 2] = u(t) | 0;
            if ((i | 0) > 0 ? ((e[r >> 2] = h(n, 4) | 0), (i | 0) > 1) : 0) {
                r = 1;
                do {
                    t = e[s >> 2] | 0;
                    e[(t + (r << 2)) >> 2] = h(n, 4) | 0;
            ...
            if ((e[s >> 2] | 0) > 0) {
                r = 0;
                do {
                    t = y[e[((e[(25640 + (e[(o + 800 + (r << 2)) >> 2] << 2)) >> 2] | 0) + 8) >> 2] & 15](f, e[(o + 1056 + (r << 2)) >> 2] | 0) | 0;
                    e[((e[a >> 2] | 0) + (r << 2)) >> 2] = t;
                    r = (r + 1) | 0;
                } while ((r | 0) < (e[s >> 2] | 0));
            }
            ...
            do {
                t = y[e[((e[(25648 + (e[(o + 1312 + (a << 2)) >> 2] << 2)) >> 2] | 0) + 8) >> 2] & 15](f, e[(o + 1568 + (a << 2)) >> 2] | 0) | 0;
                e[((e[i >> 2] | 0) + (a << 2)) >> 2] = t;
                a = (a + 1) | 0;
            } while ((a | 0) < (e[n >> 2] | 0));
            a = 0;
        ...
        function ze(t) {
            ...
            do {
                if ((n | 0) > 0) {
                    ...
                    r = 0;
                    do {
                        e[(a + (r << 2)) >> 2] = e[(t + ((n + ~r) << 2)) >> 2];
                        r = (r + 1) | 0;
                    } while ((n | 0) > (r | 0));
                }
                +je(a, d, (n - (e[l >> 2] | 0)) | 0, 16);
                r = e[l >> 2] | 0;
                t = ((e[f >> 2] | 0) - r) | 0;
                We(d, (a + ((t + -16) << 2)) | 0, 16, (a + (t << 2)) | 0, r);
                n = e[f >> 2] | 0;
                if ((n | 0) > 0) {
                    t = e[((e[c >> 2] | 0) + (o << 2)) >> 2] | 0;
                    r = 0;
                    do {
                        e[(t + ((n + ~r) << 2)) >> 2] = e[(a + (r << 2)) >> 2];
                        r = (r + 1) | 0;
                    } while ((n | 0) > (r | 0));
                }
                o = (o + 1) | 0;
            } while ((o | 0) < (e[((e[u >> 2] | 0) + 4) >> 2] | 0));
            i = s;
            return;
        }
        function Tr(t, n) {
            ...
            e: do
                if ((i | 0) != (l | 0)) {
                    ...
                    if ((i | 0) == (o | 0)) {
                        ...
                        r = 0;
                        while (1) {
                            s(n, ((a[((e[i >> 2] | 0) + r) >> 0] | 0) + -1) | 0, 5);
                            r = (r + 1) | 0;
                            if ((r | 0) >= (e[u >> 2] | 0)) break e;
                        }
                    }
                    s(n, 1, 1);
                    if ((e[u >> 2] | 0) > 0) {
            ...
            do
                if ((m | 0) == 28) {
                    ...
                    i = e[r >> 2] | 0;
                    if ((i | 0) == 1) i = Qi(t) | 0;
                    else if ((i | 0) == 2) i = f(e[t >> 2] | 0, e[u >> 2] | 0) | 0;
                    else break;
                    if ((i | 0) > 0) {
                        r = 0;
                        do {
                            t = e[((e[o >> 2] | 0) + (r << 2)) >> 2] | 0;
                            s(n, (t | 0) > -1 ? t : (0 - t) | 0, e[l >> 2] | 0);
                            r = (r + 1) | 0;
                        } while ((r | 0) != (i | 0));
                    }
                }
        ...
        function X(t, i, n) {
            ...
            s(n, e[((e[(t + 20) >> 2] | 0) + (i << 2)) >> 2] | 0, a[((e[(o + 8) >> 2] | 0) + i) >> 0] | 0);
            r = a[((e[((e[r >> 2] | 0) + 8) >> 2] | 0) + i) >> 0] | 0;
            return r | 0;
        }
        function J(i, r) {
            i = i | 0;
        ...
        function Pr(o, s, d, t) {
            ...
            while (1) {
                ...
                do {
                    o = (s + ((a + n) << 2)) | 0;
                    r[o >> 2] = +r[o >> 2] + +r[((e[(m + (a << 2)) >> 2] | 0) + (t << 2)) >> 2];
                    a = (a + 1) | 0;
                } while ((a | 0) != (l | 0));
                t = (t + 1) | 0;
                if ((t | 0) >= (u | 0)) {
        ...
        function W(t, o) {
            ...
            do
                if ((r | 0) > -1) {
                    r = e[((e[(t + 32) >> 2] | 0) + (r << 2)) >> 2] | 0;
                    if ((r | 0) < 0) {
                        f = ((e[(t + 8) >> 2] | 0) - (r & 32767)) | 0;
                        n = (r >>> 15) & 32767;
                        break;
                    }
                    r = (r + -1) | 0;
                    he(o, a[((e[(t + 28) >> 2] | 0) + r) >> 0] | 0);
                    return r | 0;
                } else {
                    f = e[(t + 8) >> 2] | 0;
                    n = 0;
            ...
            r = (i >>> 16) | (i << 16);
            r = ((r >>> 8) & 16711935) | ((r << 8) & -16711936);
            r = ((r >>> 4) & 252645135) | ((r << 4) & -252645136);
            r = ((r >>> 2) & 858993459) | ((r << 2) & -858993460);
            r = ((r >>> 1) & 1431655765) | ((r << 1) & -1431655766);
            i = (f - n) | 0;
            if ((i | 0) > 1) {
                c = e[(t + 20) >> 2] | 0;
                s = f;
                do {
                    f = i >> 1;
                    u = (e[(c + ((f + n) << 2)) >> 2] | 0) >>> 0 > r >>> 0;
                    n = ((u ? 0 : f) + n) | 0;
                    s = (s - (u ? f : 0)) | 0;
                    i = (s - n) | 0;
                } while ((i | 0) > 1);
            }
            r = a[((e[(t + 28) >> 2] | 0) + n) >> 0] | 0;
            if ((r | 0) > (l | 0)) {
                he(o, l);
                r = -1;
                return r | 0;
        ...
        function Ir(i, t) {
            ...
            while (1) {
                ...
                if ((f | 0) > 0) {
                    ...
                    s = 0;
                    do {
                        l = +I(+(((+(s | 0) + 0.5) / m) * 3.141592653589793));
                        r[(a + (s << 2)) >> 2] = l;
                        o = o + l;
                        s = (s + 1) | 0;
                    } while ((s | 0) != (f | 0));
            ...
            e[(i + 152) >> 2] = h((c * 7) | 0, 144) | 0;
            e[(i + 160) >> 2] = h(e[d >> 2] | 0, 4) | 0;
            return;
        }
        function xr(r) {
            r = r | 0;
        ...
        function Hr(l) {
            ...
            if ((i | 0) < (m | 0)) {
                ...
                do {
                    a = e[o >> 2] | 0;
                    e[o >> 2] = (a | 0) > 23 ? 24 : (a + 1) | 0;
                    if ((e[n >> 2] | 0) > 0) {
                        r = 0;
                        a = 0;
                        do {
                            v = ((e[((e[s >> 2] | 0) + (r << 2)) >> 2] | 0) + ((f(e[w >> 2] | 0, i) | 0) << 2)) | 0;
                            a = qr(n, c, v, t, ((e[d >> 2] | 0) + ((((r * 7) | 0) * 144) | 0)) | 0) | 0 | a;
                            r = (r + 1) | 0;
                        } while ((r | 0) < (e[n >> 2] | 0));
                        r = e[u >> 2] | 0;
                        e[(r + ((i + 2) << 2)) >> 2] = 0;
                        ...
                        if (((a & 2) | 0) != 0 ? ((e[(r + (i << 2)) >> 2] = 1), (i | 0) > 0) : 0) e[(r + ((i + -1) << 2)) >> 2] = 1;
                        if (a & 4) e[o >> 2] = -1;
                    } else e[((e[u >> 2] | 0) + ((i + 2) << 2)) >> 2] = 0;
                    i = (i + 1) | 0;
                } while ((i | 0) != (m | 0));
            }
            i = e[w >> 2] | 0;
            ...
            e[p >> 2] = o;
            a = e[(l + 48) >> 2] | 0;
            s = ((((e[(h + (e[(l + 40) >> 2] << 2)) >> 2] | 0) / 4) | 0) + a + (((e[(h + 4) >> 2] | 0) / 2) | 0) + (((e[h >> 2] | 0) / 4) | 0)) | 0;
            u = (n + 176) | 0;
            t = e[u >> 2] | 0;
            o = (o - i) | 0;
            if ((t | 0) >= (o | 0)) {
            ...
            while (1) {
                ...
                e[u >> 2] = t;
                if ((t | 0) > (a | 0) ? (e[((e[r >> 2] | 0) + ((((t | 0) / (i | 0)) | 0) << 2)) >> 2] | 0) != 0 : 0) {
                    s = 21;
                    break;
                }
                t = (i + t) | 0;
        ...
        function Ur(r) {
            ...
            if (!i) {
                ...
                i = ((e[(t + (e[(r + 44) >> 2] << 2)) >> 2] | 0) / 4) | 0;
                r = ((e[(t + (e[(r + 36) >> 2] << 2)) >> 2] | 0) / 4) | 0;
            }
            t = (a - n - r) | 0;
            i = (n + a + i) | 0;
            r = e[(o + 172) >> 2] | 0;
        ...
        function it(t, n) {
            ...
            r = ((n | 0) / (o | 0)) | 0;
            a = e[(t + 160) >> 2] | 0;
            B(a | 0, (a + (r << 2)) | 0, (((((e[i >> 2] | 0) / (o | 0)) | 0) + 2 - r) << 2) | 0) | 0;
            e[i >> 2] = (e[i >> 2] | 0) - n;
            i = (t + 172) | 0;
            r = e[i >> 2] | 0;
            if ((r | 0) <= -1) {
        ...
        function qr(l, S, c, v, d) {
            ...
            r[f >> 2] = s;
            n = e[l >> 2] | 0;
            e[l >> 2] = (n | 0) > 13 ? 0 : (n + 1) | 0;
            n = ((o | 0) / 2) | 0;
            e: do
                if ((o | 0) > 1) {
                    s = (+((((r[p >> 2] = u * 0.0625), e[p >> 2] | 0) & 2147483647) >>> 0) * 7.177114298428933e-7 + -764.6162109375) * 0.5 + -15;
                    a = 0;
                    while (1) {
                        u = +r[(m + ((a | 1) << 2)) >> 2];
                        t = +((((r[p >> 2] = u * u + t * t), e[p >> 2] | 0) & 2147483647) >>> 0) * 3.5885571492144663e-7 + -382.30810546875;
                        t = t < s ? s : t;
                        r[(m + ((a >> 1) << 2)) >> 2] = t < _ ? _ : t;
                        a = (a + 2) | 0;
                        if ((a | 0) >= (n | 0)) break e;
            ...
            if ((E | 0) > 0) {
                ...
                do {
                    ...
                    E = (d + ((o * 144) | 0) + 68) | 0;
                    n = e[E >> 2] | 0;
                    s = +r[(d + ((o * 144) | 0) + ((((n | 0) < 1 ? 16 : -1) + n) << 2)) >> 2];
                    r[(d + ((o * 144) | 0) + (n << 2)) >> 2] = t;
                    n = e[E >> 2] | 0;
                    e[E >> 2] = (n | 0) > 15 ? 0 : (n + 1) | 0;
                    a = (t < s ? s : t) + 99999 > +r[(S + 4 + (o << 2)) >> 2] + w ? a | 5 : a;
                    a = (t > s ? s : t) + -99999 < +r[(S + 32 + (o << 2)) >> 2] - w ? a | 2 : a;
                    o = (o + 1) | 0;
                } while ((o | 0) != 7);
                i = b;
                return a | 0;
            ...
            do {
                ...
                r[(d + ((h * 144) | 0) + (l << 2)) >> 2] = _;
                o = e[f >> 2] | 0;
                e[f >> 2] = (o | 0) > 15 ? 0 : (o + 1) | 0;
                a = y - u > +r[(S + 4 + (h << 2)) >> 2] + w ? a | 5 : a;
                a = t - s < +r[(S + 32 + (h << 2)) >> 2] - w ? a | 2 : a;
                h = (h + 1) | 0;
            } while ((h | 0) != 7);
            i = b;
            return a | 0;
        ...
        function j(te, D, Y, X) {
                        ...
                        if (o) {
                            ...
                            do {
                                ...
                                if ((V | 0) < (n | 0)) {
                                    ...
                                    while (1) {
                                        T = +r[(X + (n << 2)) >> 2];
                                        d = ~~(T * 7.314285755157471 + 1023.5);
                                        d = (d | 0) > 1023 ? 1023 : (d | 0) < 0 ? 0 : d;
                                        do
                                            if (d)
                                                if (!(+r[ee >> 2] + +r[(Y + (n << 2)) >> 2] >= T)) {
                                                    P = (P + 1) | 0;
                                                    c = ((f(n, n) | 0) + c) | 0;
                                                    o = (n + o) | 0;
                                                    y = ((f(d, n) | 0) + y) | 0;
            ...
            if ((O | 0) == 9) {
                ...
                if ((B | 0) < 1) {
                    ...
                    do {
                        S = +r[(X + (l << 2)) >> 2];
                        c = ~~(S * 7.314285755157471 + 1023.5);
                        c = (c | 0) > 1023 ? 1023 : (c | 0) < 0 ? 0 : c;
                        do
                            if (c)
                                if (!(+r[P >> 2] + +r[(Y + (l << 2)) >> 2] >= S)) {
                                    m = (m + 1) | 0;
                                    N = ((f(l, l) | 0) + N) | 0;
                                    k = (l + k) | 0;
                                    u = ((f(c, l) | 0) + u) | 0;
                    ...
                    e: while (1) {
                        ...
                        r: do
                            if ((e[t >> 2] | 0) != (A | 0)) {
                                ...
                                s = (u >> 31) | 1;
                                S = +r[(X + (c << 2)) >> 2];
                                m = ~~(S * 7.314285755157471 + 1023.5);
                                m = (m | 0) > 1023 ? 1023 : (m | 0) < 0 ? 0 : m;
                                y = f(N, F) | 0;
                                y = (((u | 0) > -1 ? u : (0 - u) | 0) - ((y | 0) > -1 ? y : (0 - y) | 0)) | 0;
                                u = (n - m) | 0;
                                u = f(u, u) | 0;
                                x = +r[z >> 2];
                                if (x + +r[(Y + (c << 2)) >> 2] >= S) {
                                    T = +(n | 0);
                                    S = +(m | 0);
                                    if (!(+r[Q >> 2] + T < S) ? !(T - +r[re >> 2] > S) : 0) O = 42;
                                } else O = 42;
                                i: do
                                    if ((O | 0) == 42) {
                                        O = 0;
                                        ...
                                        if ((m | 0) < (V | 0)) {
                                            ...
                                            do {
                                                ...
                                                P = (P + N + (l ? 0 : s)) | 0;
                                                S = +r[(X + (m << 2)) >> 2];
                                                l = ~~(S * 7.314285755157471 + 1023.5);
                                                l = (l | 0) > 1023 ? 1023 : (l | 0) < 0 ? 0 : l;
                                                h = (P - l) | 0;
                                                u = ((f(h, h) | 0) + u) | 0;
                                                k = (k + 1) | 0;
                                                if ((l | 0) != 0 ? +r[(Y + (m << 2)) >> 2] + x >= S : 0) {
                                                    S = +(P | 0);
                                                    T = +(l | 0);
                                                    if (+r[Q >> 2] + S < T) break i;
                                        ...
                                        S = +(k | 0);
                                        T = +r[ne >> 2];
                                        if ((!((x * x) / S > T) ? ((x = +r[re >> 2]), !((x * x) / S > T)) : 0) ? +(((u | 0) / (k | 0)) | 0 | 0) > T : 0) break;
                                        e[(L + (R << 2)) >> 2] = -200;
                                        e[(I + (R << 2)) >> 2] = -200;
                                        break r;
                                    }
                                ...
                                e[j >> 2] = -200;
                                e[Z >> 2] = -200;
                                t = se((a + ((o * 56) | 0)) | 0, (C - o) | 0, K, W, M) | 0;
                                h = se((a + ((C * 56) | 0)) | 0, (ee - C) | 0, j, Z, M) | 0;
                                t = (t | 0) != 0;
                                if (t) {
                                    e[K >> 2] = n;
                                    e[W >> 2] = e[j >> 2];
                                }
                                if ((h | 0) != 0 ? ((e[j >> 2] = e[W >> 2]), (e[Z >> 2] = d), t) : 0) {
                                    e[(L + (R << 2)) >> 2] = -200;
                                    e[(I + (R << 2)) >> 2] = -200;
                                    break;
                                }
            ...
            do {
                ...
                n = e[(M + 836 + (o << 2)) >> 2] | 0;
                o = e[(s + (o << 2)) >> 2] & 32767;
                p = ((e[(s + (v << 2)) >> 2] & 32767) - o) | 0;
                n = ((f((p | 0) > -1 ? p : (0 - p) | 0, ((e[(M + 836 + (t << 2)) >> 2] | 0) - n) | 0) | 0) / (((e[(M + 836 + (v << 2)) >> 2] | 0) - n) | 0)) | 0;
                o = (((p | 0) < 0 ? (0 - n) | 0 : n) + o) | 0;
                n = e[(L + (t << 2)) >> 2] | 0;
                p = e[(I + (t << 2)) >> 2] | 0;
                if ((n | 0) >= 0) {
                ...
                e[(s + (t << 2)) >> 2] = ((n | 0) < 0) | ((o | 0) == (n | 0)) ? o | 32768 : n;
                t = (t + 1) | 0;
            } while ((t | 0) != (b | 0));
            i = _;
            return s | 0;
        }
        function E(i, r, n, o, a) {
            i = i | 0;
            r = r | 0;
            n = n | 0;
            o = o | 0;
            ...
            do {
                ...
                i = f(e[l >> 2] & 32767, d) | 0;
                u = (o + (t << 2)) | 0;
                i = (i + 32768 + (f(e[u >> 2] & 32767, a) | 0)) >> 16;
                c = (r + (t << 2)) | 0;
                e[c >> 2] = i;
                if (((e[l >> 2] & 32768) | 0) != 0 ? ((e[u >> 2] & 32768) | 0) != 0 : 0) e[c >> 2] = i | 32768;
                t = (t + 1) | 0;
            } while ((t | 0) != (s | 0));
            return r | 0;
        }
        function Wr(F, O, _, b, T) {
            F = F | 0;
            O = O | 0;
            _ = _ | 0;
            b = b | 0;
            ...
            L = (_ + 1284) | 0;
            d = e[L >> 2] | 0;
            P = e[((e[((e[(O + 64) >> 2] | 0) + 4) >> 2] | 0) + 28) >> 2] | 0;
            D = e[(P + 2848) >> 2] | 0;
            if (!b) {
                s(F, 0, 1);
                w(T | 0, 0, ((((e[(O + 36) >> 2] | 0) / 2) | 0) << 2) | 0) | 0;
                v = 0;
                i = R;
                return v | 0;
            }
            ...
            if ((d | 0) > 2) {
                ...
                do {
                    ...
                    o = e[l >> 2] & 32767;
                    r = ((e[a >> 2] & 32767) - o) | 0;
                    n = ((f((r | 0) > -1 ? r : (0 - r) | 0, ((e[(h + 836 + (t << 2)) >> 2] | 0) - n) | 0) | 0) / (((e[(h + 836 + (c << 2)) >> 2] | 0) - n) | 0)) | 0;
                    n = (((r | 0) < 0 ? (0 - n) | 0 : n) + o) | 0;
                    r = (b + (t << 2)) | 0;
                    c = e[r >> 2] | 0;
                    if ((((c & 32768) | 0) != 0) | ((c | 0) == (n | 0))) {
                        e[r >> 2] = n | 32768;
                        e[(v + (t << 2)) >> 2] = 0;
                    } else {
                        u = ((e[g >> 2] | 0) - n) | 0;
            ...
            N = (_ + 1304) | 0;
            e[N >> 2] = (e[N >> 2] | 0) + k;
            s(F, o, S(((e[g >> 2] | 0) + -1) | 0) | 0);
            s(F, t, S(((e[g >> 2] | 0) + -1) | 0) | 0);
            if ((e[h >> 2] | 0) > 0) {
                g = (_ + 1300) | 0;
                c = 0;
                k = 2;
                while (1) {
                    ...
                    if (d) {
                        ...
                        if (!m) {
                            l = 0;
                            do {
                                r = e[(h + 320 + (E << 5) + (l << 2)) >> 2] | 0;
                                if ((r | 0) < 0) r = 1;
                                else r = e[((e[(P + 1824 + (r << 2)) >> 2] | 0) + 4) >> 2] | 0;
                                e[(y + (l << 2)) >> 2] = r;
                                l = (l + 1) | 0;
                            } while ((l | 0) < (A | 0));
                        }
                        e: do
                            if ((M | 0) > 0) {
                                ...
                                while (1) {
                                    ...
                                    if ((a | 0) == 31) e[(p + (t << 2)) >> 2] = l;
                                    else if ((a | 0) == 33) l = e[(p + (t << 2)) >> 2] | 0;
                                    n = (l << o) | n;
                                    t = (t + 1) | 0;
                                    if ((t | 0) == (M | 0)) break;
                                    else o = (o + d) | 0;
                        ...
                        while (0);
                        d = X((D + (((e[(h + 256 + (E << 2)) >> 2] | 0) * 56) | 0)) | 0, n, F) | 0;
                        e[g >> 2] = (e[g >> 2] | 0) + d;
                    }
                    if ((M | 0) > 0) {
                        r = 0;
                        do {
                            n = e[(h + 320 + (E << 5) + (e[(p + (r << 2)) >> 2] << 2)) >> 2] | 0;
                            if ((n | 0) > -1 ? ((B = e[(v + ((r + k) << 2)) >> 2] | 0), (B | 0) < (e[(D + ((n * 56) | 0) + 4) >> 2] | 0)) : 0) {
                                d = X((D + ((n * 56) | 0)) | 0, B, F) | 0;
                                e[N >> 2] = (e[N >> 2] | 0) + d;
                            }
                            r = (r + 1) | 0;
                        } while ((r | 0) != (M | 0));
                    ...
                    c = (c + 1) | 0;
                    if ((c | 0) >= (e[h >> 2] | 0)) break;
                    else k = (M + k) | 0;
                }
            }
            d = (h + 832) | 0;
            t = f(e[d >> 2] | 0, e[b >> 2] | 0) | 0;
            g = ((e[(P + (e[(O + 28) >> 2] << 2)) >> 2] | 0) / 2) | 0;
            if ((e[L >> 2] | 0) > 1) {
                a = 0;
                A = 1;
                n = 0;
                ...
                while (1) {
                    ...
                    if (((t & 32767) | 0) == (t | 0)) {
                        ...
                        M = (m >> 31) | 1;
                        c = f(E, u) | 0;
                        c = (((m | 0) > -1 ? m : (0 - m) | 0) - ((c | 0) > -1 ? c : (0 - c) | 0)) | 0;
                        m = (g | 0) > (l | 0) ? l : g;
                        if ((m | 0) > (n | 0)) e[(T + (n << 2)) >> 2] = r;
                        o = (n + 1) | 0;
                        if ((o | 0) < (m | 0)) {
                            n = 0;
                            while (1) {
            ...
            do {
                e[(T + (a << 2)) >> 2] = t;
                a = (a + 1) | 0;
            } while ((a | 0) < (((e[o >> 2] | 0) / 2) | 0 | 0));
            a = 1;
            i = R;
            return a | 0;
        }
        function se(t, p, d, u, i) {
            t = t | 0;
            p = p | 0;
            d = d | 0;
            u = u | 0;
            ...
            if ((p | 0) > 0) {
                ...
                do {
                    ...
                    v = e[(t + ((i * 56) | 0) + 28) >> 2] | 0;
                    c = (+((v + E) | 0) * h) / +((v + 1) | 0) + 1;
                    o = +(e[(t + ((i * 56) | 0) + 32) >> 2] | 0) + o + +(e[(t + ((i * 56) | 0) + 8) >> 2] | 0) * c;
                    a = +(e[(t + ((i * 56) | 0) + 36) >> 2] | 0) + a + +(e[(t + ((i * 56) | 0) + 12) >> 2] | 0) * c;
                    l = +(e[(t + ((i * 56) | 0) + 40) >> 2] | 0) + l + +(e[(t + ((i * 56) | 0) + 16) >> 2] | 0) * c;
                    s = +(e[(t + ((i * 56) | 0) + 48) >> 2] | 0) + s + +(e[(t + ((i * 56) | 0) + 24) >> 2] | 0) * c;
                    n = +(E | 0) + n + c * +(v | 0);
                    i = (i + 1) | 0;
                } while ((i | 0) != (p | 0));
            } else {
        ...
        function Xr(r, o) {
            ...
            if ((e[r >> 2] | 0) > 0) {
                ...
                if ((a | 0) > -1) {
                    ...
                    n = 0;
                    while (1) {
                        s(o, ((e[(u + (n << 2)) >> 2] | 0) + -1) | 0, 3);
                        l = (f + (n << 2)) | 0;
                        s(o, e[l >> 2] | 0, 2);
                        if (!((e[l >> 2] | 0) != 0 ? (s(o, e[(t + (n << 2)) >> 2] | 0, 8), (e[l >> 2] | 0) == 31) : 0)) {
                            i = 0;
                            d = 8;
                        }
                        if ((d | 0) == 8)
                            while (1) {
                                d = 0;
                                s(o, ((e[(c + (n << 5) + (i << 2)) >> 2] | 0) + 1) | 0, 8);
                                i = (i + 1) | 0;
                                if ((i | 0) >= ((1 << e[l >> 2]) | 0)) break;
                                else d = 8;
                            }
                        if ((n | 0) == (a | 0)) break;
                        else n = (n + 1) | 0;
        ...
        function Kr(s, c) {
            ...
            while (0);
            e: do
                if ((v | 0) == 18 ? ((e[(a + 832) >> 2] = (m(c, 2) | 0) + 1), (p = m(c, 4) | 0), (p | 0) >= 0) : 0) {
                    t = e[a >> 2] | 0;
                    if ((t | 0) > 0) {
                        E = (a + 4) | 0;
                        S = (a + 128) | 0;
        ...
        function Gr(t, a) {
            ...
            if ((d | 0) == 7) {
                ...
                n = 0;
                do {
                    e[(o + (n << 2)) >> 2] = e[(m + (e[(r + (n << 2)) >> 2] << 2)) >> 2];
                    n = (n + 1) | 0;
                } while ((n | 0) < (t | 0));
                n = f;
            }
            t = e[(a + 832) >> 2] | 0;
            if ((t | 0) == 2) e[(o + 1292) >> 2] = 128;
            else if ((t | 0) == 3) e[(o + 1292) >> 2] = 86;
            else if ((t | 0) == 1) e[(o + 1292) >> 2] = 256;
            else if ((t | 0) == 4) e[(o + 1292) >> 2] = 64;
            if ((n | 0) <= 0) {
                i = v;
                return o | 0;
            }
        ...
        function Qr(i, h) {
            ...
            var r = 0,
                ...
                v = 0;
            u = e[(h + 1296) >> 2] | 0;
            E = e[((e[((e[((e[(i + 64) >> 2] | 0) + 4) >> 2] | 0) + 28) >> 2] | 0) + 2848) >> 2] | 0;
            w = (i + 4) | 0;
            if ((m(w, 1) | 0) != 1) {
                a = 0;
                return a | 0;
            ...
            i = g(i, e[v >> 2] << 2) | 0;
            p = (h + 1292) | 0;
            e[i >> 2] = m(w, S(((e[p >> 2] | 0) + -1) | 0) | 0) | 0;
            e[(i + 4) >> 2] = m(w, S(((e[p >> 2] | 0) + -1) | 0) | 0) | 0;
            e: do
                if ((e[u >> 2] | 0) > 0) {
                    o = 0;
                    r = 2;
                    r: while (1) {
                        ...
                        a = 1 << t;
                        if (t) {
                            c = J((E + (((e[(u + 256 + (l << 2)) >> 2] | 0) * 56) | 0)) | 0, w) | 0;
                            if ((c | 0) == -1) {
                                i = 0;
                                r = 25;
                                break;
                        ...
                        o = (o + 1) | 0;
                        if ((o | 0) >= (e[u >> 2] | 0)) break e;
                        else r = (d + r) | 0;
                    }
                    if ((r | 0) == 25) return i | 0;
                }
            while (0);
            if ((e[v >> 2] | 0) <= 2) {
                a = i;
            ...
            do {
                ...
                o = e[l >> 2] | 0;
                t = e[(i + (t << 2)) >> 2] & 32767;
                n = ((e[(i + (o << 2)) >> 2] & 32767) - t) | 0;
                r = ((f((n | 0) > -1 ? n : (0 - n) | 0, ((e[(u + 836 + (s << 2)) >> 2] | 0) - r) | 0) | 0) / (((e[(u + 836 + (o << 2)) >> 2] | 0) - r) | 0)) | 0;
                t = (((n | 0) < 0 ? (0 - r) | 0 : r) + t) | 0;
                r = ((e[p >> 2] | 0) - t) | 0;
                n = (i + (s << 2)) | 0;
                o = e[n >> 2] | 0;
        ...
        function $r(i, t, m, d) {
            ...
            var y = 0,
                ...
                _ = 0;
            E = e[(t + 1296) >> 2] | 0;
            c = ((e[((e[((e[((e[(i + 64) >> 2] | 0) + 4) >> 2] | 0) + 28) >> 2] | 0) + (e[(i + 28) >> 2] << 2)) >> 2] | 0) / 2) | 0;
            if (!m) {
                w(d | 0, 0, (c << 2) | 0) | 0;
                n = 0;
                return n | 0;
            ...
            if ((g | 0) > 1) {
                ...
                while (1) {
                    ...
                    if (((o & 32767) | 0) == (o | 0)) {
                        ...
                        k = (n >> 31) | 1;
                        u = f(v, h) | 0;
                        u = (((n | 0) > -1 ? n : (0 - n) | 0) - ((u | 0) > -1 ? u : (0 - u) | 0)) | 0;
                        n = (c | 0) > (l | 0) ? l : c;
                        if ((n | 0) > (a | 0)) {
                            o = (d + (a << 2)) | 0;
                            r[o >> 2] = +r[o >> 2] * +r[(1768 + (s << 2)) >> 2];
                        }
                        o = (a + 1) | 0;
                        if ((o | 0) < (n | 0)) {
                            a = 0;
        ...
        function ei(r, i) {
            r = r | 0;
            i = i | 0;
            return ((e[e[r >> 2] >> 2] | 0) - (e[e[i >> 2] >> 2] | 0)) | 0;
        }
        function ri(r) {
            r = r | 0;
            e[r >> 2] = 0;
        ...
        function ii(o, r, n) {
            ...
            Ie(s | 0, n | 0) | 0;
            r = (o + 8) | 0;
            e[o >> 2] = M(e[o >> 2] | 0, ((e[r >> 2] << 2) + 8) | 0) | 0;
            t = (o + 4) | 0;
            f = M(e[t >> 2] | 0, ((e[r >> 2] << 2) + 8) | 0) | 0;
            e[t >> 2] = f;
            t = V(s | 0) | 0;
            n = e[r >> 2] | 0;
            e[(f + (n << 2)) >> 2] = t;
        ...
        function ae(o) {
            ...
            if ((i | 0) > 0) {
                ...
                do {
                    t = e[(a + 544 + (r << 2)) >> 2] | 0;
                    if (t) {
                        R[e[((e[(25664 + (e[(a + 288 + (r << 2)) >> 2] << 2)) >> 2] | 0) + 8) >> 2] & 7](t);
                        i = e[s >> 2] | 0;
                    }
                    r = (r + 1) | 0;
                } while ((r | 0) < (i | 0));
            ...
            if ((i | 0) > 0) {
                ...
                do {
                    t = e[(a + 1056 + (r << 2)) >> 2] | 0;
                    if (t) {
                        R[e[((e[(25640 + (e[(a + 800 + (r << 2)) >> 2] << 2)) >> 2] | 0) + 12) >> 2] & 7](t);
                        i = e[s >> 2] | 0;
                    }
                    r = (r + 1) | 0;
                } while ((r | 0) < (i | 0));
            ...
            if ((i | 0) > 0) {
                ...
                do {
                    t = e[(a + 1568 + (r << 2)) >> 2] | 0;
                    if (t) {
                        R[e[((e[(25648 + (e[(a + 1312 + (r << 2)) >> 2] << 2)) >> 2] | 0) + 12) >> 2] & 7](t);
                        i = e[s >> 2] | 0;
                    }
                    r = (r + 1) | 0;
                } while ((r | 0) < (i | 0));
        ...
        function ai(t, w, l, f, c) {
            ...
            if ((e[p >> 2] | 0) >= 1) {
                ...
                m = (v + 28) | 0;
                t = e[m >> 2] | 0;
                if (((t | 0) != 0 ? ((o = e[t >> 2] | 0), (o | 0) >= 64) : 0) ? ((a = (t + 4) | 0), (e[a >> 2] | 0) >= (o | 0)) : 0) {
                    s(r, 1, 8);
                    s(r, 118, 8);
                    s(r, 111, 8);
                    s(r, 114, 8);
                    ...
                    s(r, e[(v + 16) >> 2] | 0, 32);
                    s(r, e[(v + 20) >> 2] | 0, 32);
                    s(r, S(((e[t >> 2] | 0) + -1) | 0) | 0, 4);
                    s(r, S(((e[a >> 2] | 0) + -1) | 0) | 0, 4);
                    s(r, 1, 1);
                    p = (E + 64) | 0;
                    t = e[p >> 2] | 0;
                    if (t) n(t);
                    ...
                    e: do
                        if (m) {
                            ...
                            if ((e[t >> 2] | 0) > 0) {
                                o = 0;
                                do {
                                    if (Tr(e[(m + 1824 + (o << 2)) >> 2] | 0, r) | 0) break e;
                                    o = (o + 1) | 0;
                                } while ((o | 0) < (e[t >> 2] | 0));
                            }
                            s(r, 0, 6);
                            ...
                            if ((e[t >> 2] | 0) > 0) {
                                ...
                                do {
                                    o = (m + 800 + (a << 2)) | 0;
                                    s(r, e[o >> 2] | 0, 16);
                                    o = e[e[(25640 + (e[o >> 2] << 2)) >> 2] >> 2] | 0;
                                    if (!o) break e;
                                    ue[o & 3](e[(m + 1056 + (a << 2)) >> 2] | 0, r);
                                    a = (a + 1) | 0;
                                } while ((a | 0) < (e[t >> 2] | 0));
                            }
                            o = (m + 20) | 0;
                            ...
                            if ((e[o >> 2] | 0) > 0) {
                                ...
                                do {
                                    h = (m + 1312 + (a << 2)) | 0;
                                    s(r, e[h >> 2] | 0, 16);
                                    ue[e[e[(25648 + (e[h >> 2] << 2)) >> 2] >> 2] & 3](e[(m + 1568 + (a << 2)) >> 2] | 0, r);
                                    a = (a + 1) | 0;
                                } while ((a | 0) < (e[o >> 2] | 0));
                            }
                            o = (m + 12) | 0;
                            ...
                            if ((e[o >> 2] | 0) > 0) {
                                ...
                                do {
                                    h = (m + 288 + (a << 2)) | 0;
                                    s(r, e[h >> 2] | 0, 16);
                                    ye[e[e[(25664 + (e[h >> 2] << 2)) >> 2] >> 2] & 1](v, e[(m + 544 + (a << 2)) >> 2] | 0, r);
                                    a = (a + 1) | 0;
                                } while ((a | 0) < (e[o >> 2] | 0));
                            }
                            a = (m + 8) | 0;
                            ...
                            if ((e[a >> 2] | 0) > 0) {
                                ...
                                do {
                                    h = (m + 32 + (o << 2)) | 0;
                                    s(r, e[e[h >> 2] >> 2] | 0, 1);
                                    s(r, e[((e[h >> 2] | 0) + 4) >> 2] | 0, 16);
                                    s(r, e[((e[h >> 2] | 0) + 8) >> 2] | 0, 16);
                                    s(r, e[((e[h >> 2] | 0) + 12) >> 2] | 0, 8);
                                    o = (o + 1) | 0;
                                } while ((o | 0) < (e[a >> 2] | 0));
                            }
                            s(r, 1, 1);
        ...
        function si(r, o) {
            ...
            n = 0;
            do {
                if (e[((e[o >> 2] | 0) + (n << 2)) >> 2] | 0) {
                    s(r, e[((e[l >> 2] | 0) + (n << 2)) >> 2] | 0, 32);
                    i = e[((e[l >> 2] | 0) + (n << 2)) >> 2] | 0;
                    if (i) {
                        t = e[((e[o >> 2] | 0) + (n << 2)) >> 2] | 0;
                        while (1) {
        ...
        function je(o, S, a, f) {
            ...
            if ((p | 0) == 8) w((u + (e << 3)) | 0, 0, ((f - e) << 3) | 0) | 0;
            if (c) {
                n = 0.99;
                e = 0;
            } else {
        ...
        function We(h, n, t, u, o) {
            ...
            c = i;
            s = i;
            i = (i + ((((1 * ((o + t) << 2)) | 0) + 15) & -16)) | 0;
            e = (t | 0) > 0;
            if (!n) {
                if (e) w(s | 0, 0, (t << 2) | 0) | 0;
            } else if (e) d(s | 0, n | 0, (t << 2) | 0) | 0;
            if ((o | 0) <= 0) {
                i = c;
                return;
            }
        ...
        function ci(i, s) {
            ...
            r = (i + 4) | 0;
            e: do
                if ((e[r >> 2] | 0) >= 1 ? ((o = m(s, 1) | 0), (o | 0) >= 0) : 0) {
                    if (o) {
                        a = m(s, 4) | 0;
                        e[t >> 2] = a + 1;
                        if ((a | 0) < 0) break;
                    ...
                    if ((i | 0) >= 0) {
                        if (i) {
                            ...
                            do {
                                l = m(s, S((i + -1) | 0) | 0) | 0;
                                e[(p + (a << 2)) >> 2] = l;
                                u = m(s, S(((e[r >> 2] | 0) + -1) | 0) | 0) | 0;
                                e[(o + (a << 2)) >> 2] = u;
                                if (((l | 0) == (u | 0)) | ((u | l | 0) < 0)) break e;
                                i = e[r >> 2] | 0;
                                a = (a + 1) | 0;
                                if (!(((l | 0) < (i | 0)) & ((u | 0) < (i | 0)))) break e;
                            } while ((a | 0) < (e[d >> 2] | 0));
                        }
                        if (!(m(s, 2) | 0)) {
                            i = e[t >> 2] | 0;
                            ...
                            do {
                                ...
                                r = m(s, 8) | 0;
                                e[(f + (o << 2)) >> 2] = r;
                                if ((r | 0) < 0 ? 1 : (r | 0) >= (e[p >> 2] | 0)) break e;
                                r = m(s, 8) | 0;
                                e[(d + (o << 2)) >> 2] = r;
                                o = (o + 1) | 0;
                                if ((r | 0) < 0 ? 1 : (r | 0) >= (e[i >> 2] | 0)) break e;
                            } while ((o | 0) < (e[t >> 2] | 0));
                            return t | 0;
                        }
                    }
        ...
        function hi(o) {
            ...
            P = e[D >> 2] | 0;
            y = e[(A + 544 + (P << 2)) >> 2] | 0;
            k = ((e[(b + 56) >> 2] | 0) + ((((((P | 0) != 0 ? 2 : 0) + (e[(q + 8) >> 2] | 0)) | 0) * 52) | 0)) | 0;
            R = (o + 40) | 0;
            e[R >> 2] = P;
            if ((v | 0) > 0) {
                M = ((t | 0) / 2) | 0;
                a = M << 2;
                C = +((((r[p >> 2] = 4 / +(t | 0)), e[p >> 2] | 0) & 2147483647) >>> 0) * 7.177114298428933e-7 + -764.6162109375 + 0.345;
                c = (b + 4) | 0;
                h = (o + 24) | 0;
                m = (o + 32) | 0;
                W = C + -764.6162109375;
                ...
                while (1) {
                    ...
                    S = (N + (l << 2)) | 0;
                    e[S >> 2] = g(o, a) | 0;
                    mt(f, c, A, e[h >> 2] | 0, e[D >> 2] | 0, e[m >> 2] | 0);
                    Xe(e[e[(b + 12 + (e[D >> 2] << 2)) >> 2] >> 2] | 0, f, e[S >> 2] | 0);
                    ot((b + 20 + (((e[D >> 2] | 0) * 12) | 0)) | 0, f);
                    _ = W + +((e[f >> 2] & 2147483647) >>> 0) * 7.177114298428933e-7 + 0.345;
                    r[f >> 2] = _;
                    S = (B + (l << 2)) | 0;
                    r[S >> 2] = _;
                    if (u) {
                        ...
                        do {
                            ...
                            v = (d + 1) | 0;
                            V = +r[(f + (v << 2)) >> 2];
                            T = C + +((((r[p >> 2] = V * V + T * T), e[p >> 2] | 0) & 2147483647) >>> 0) * 3.5885571492144663e-7 + 0.345;
                            r[(f + ((v >> 1) << 2)) >> 2] = T;
                            if (T > _) {
                                r[S >> 2] = T;
                                _ = T;
                ...
                if ((a | 0) > 0) {
                    ...
                    if ((t | 0) > 1) d = 0;
                        ...
                        while (1) {
                            ...
                            Je(k, c, F);
                            Qe(k, h, v, _, +r[(B + (f << 2)) >> 2]);
                            U(k, F, v, 1, h, m, c);
                            n = (y + 1028 + (n << 2)) | 0;
                            a = e[n >> 2] | 0;
                            if ((e[(A + 800 + (a << 2)) >> 2] | 0) != 1) {
                                a = -1;
                                break;
                            }
                            t = j(o, e[((e[u >> 2] | 0) + (a << 2)) >> 2] | 0, c, h) | 0;
                            e[((e[l >> 2] | 0) + 28) >> 2] = t;
                            if ((K(o) | 0) != 0 ? (e[((e[l >> 2] | 0) + 28) >> 2] | 0) != 0 : 0) {
                                U(k, F, v, 2, h, m, c);
                                t = j(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, c, h) | 0;
                                e[((e[l >> 2] | 0) + 56) >> 2] = t;
                                U(k, F, v, 0, h, m, c);
                                t = j(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, c, h) | 0;
                                e[e[l >> 2] >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[t >> 2] | 0, e[(t + 28) >> 2] | 0, 9362) | 0;
                                e[((e[l >> 2] | 0) + 4) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[t >> 2] | 0, e[(t + 28) >> 2] | 0, 18724) | 0;
                                e[((e[l >> 2] | 0) + 8) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[t >> 2] | 0, e[(t + 28) >> 2] | 0, 28086) | 0;
                                e[((e[l >> 2] | 0) + 12) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[t >> 2] | 0, e[(t + 28) >> 2] | 0, 37449) | 0;
                                e[((e[l >> 2] | 0) + 16) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[t >> 2] | 0, e[(t + 28) >> 2] | 0, 46811) | 0;
                                e[((e[l >> 2] | 0) + 20) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[t >> 2] | 0, e[(t + 28) >> 2] | 0, 56173) | 0;
                                e[((e[l >> 2] | 0) + 24) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[(t + 28) >> 2] | 0, e[(t + 56) >> 2] | 0, 9362) | 0;
                                e[((e[l >> 2] | 0) + 32) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[(t + 28) >> 2] | 0, e[(t + 56) >> 2] | 0, 18724) | 0;
                                e[((e[l >> 2] | 0) + 36) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[(t + 28) >> 2] | 0, e[(t + 56) >> 2] | 0, 28086) | 0;
                                e[((e[l >> 2] | 0) + 40) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[(t + 28) >> 2] | 0, e[(t + 56) >> 2] | 0, 37449) | 0;
                                e[((e[l >> 2] | 0) + 44) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[(t + 28) >> 2] | 0, e[(t + 56) >> 2] | 0, 46811) | 0;
                                e[((e[l >> 2] | 0) + 48) >> 2] = t;
                                t = e[l >> 2] | 0;
                                t = E(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, e[(t + 28) >> 2] | 0, e[(t + 56) >> 2] | 0, 56173) | 0;
                                e[((e[l >> 2] | 0) + 52) >> 2] = t;
                            }
                            f = (f + 1) | 0;
                            a = e[w >> 2] | 0;
                    ...
                    while (1) {
                        ...
                        n = 0;
                        do {
                            r[(c + ((n + M) << 2)) >> 2] = +((e[(h + (n << 2)) >> 2] & 2147483647) >>> 0) * 7.177114298428933e-7 + -764.6162109375 + 0.345;
                            n = (n + 1) | 0;
                        } while ((n | 0) < (M | 0));
                        Je(k, l, F);
                        Qe(k, c, v, _, +r[(B + (d << 2)) >> 2]);
                        U(k, F, v, 1, c, h, l);
                        n = (y + 1028 + (m << 2)) | 0;
                        a = e[n >> 2] | 0;
                        if ((e[(A + 800 + (a << 2)) >> 2] | 0) != 1) {
                        ...
                        t = j(o, e[((e[u >> 2] | 0) + (a << 2)) >> 2] | 0, l, c) | 0;
                        e[((e[f >> 2] | 0) + 28) >> 2] = t;
                        if ((K(o) | 0) != 0 ? (e[((e[f >> 2] | 0) + 28) >> 2] | 0) != 0 : 0) {
                            U(k, F, v, 2, c, h, l);
                            t = j(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, l, c) | 0;
                            e[((e[f >> 2] | 0) + 56) >> 2] = t;
                            U(k, F, v, 0, c, h, l);
                            t = j(o, e[((e[u >> 2] | 0) + (e[n >> 2] << 2)) >> 2] | 0, l, c) | 0;
                            e[e[f >> 2] >> 2] = t;
            ...
            while (1) {
                ...
                if ((a | 0) > 0) {
                    n = 0;
                    do {
                        e[(x + (n << 2)) >> 2] = Wr(h, o, e[((e[u >> 2] | 0) + (e[(y + 1028 + (e[(y + 4 + (n << 2)) >> 2] << 2)) >> 2] << 2)) >> 2] | 0, e[((e[(I + (n << 2)) >> 2] | 0) + (c << 2)) >> 2] | 0, e[(L + (n << 2)) >> 2] | 0) | 0;
                        n = (n + 1) | 0;
                        a = e[w >> 2] | 0;
                    } while ((n | 0) < (a | 0));
                }
                Ti(c, v, k, y, N, L, x, e[(A + 3240 + (((e[D >> 2] | 0) * 60) | 0) + (c << 2)) >> 2] | 0, a);
                if ((e[y >> 2] | 0) > 0) {
                    d = 0;
                    do {
                        S = e[(y + 1092 + (d << 2)) >> 2] | 0;
                        ...
                        if ((n | 0) > 0) {
                            ...
                            m = 0;
                            do {
                                if ((e[(y + 4 + (m << 2)) >> 2] | 0) == (d | 0)) {
                                    e[(R + (a << 2)) >> 2] = ((e[(x + (m << 2)) >> 2] | 0) != 0) & 1;
                                    e[(O + (a << 2)) >> 2] = e[(L + (m << 2)) >> 2];
                                    n = e[w >> 2] | 0;
                                    a = (a + 1) | 0;
                                }
                        ...
                        f = (A + 1312 + (S << 2)) | 0;
                        l = Se[e[((e[(25648 + (e[f >> 2] << 2)) >> 2] | 0) + 20) >> 2] & 7](o, e[((e[M >> 2] | 0) + (S << 2)) >> 2] | 0, O, R, n) | 0;
                        m = e[w >> 2] | 0;
                        if ((m | 0) > 0) {
                            n = 0;
                            a = 0;
                            do {
                                if ((e[(y + 4 + (a << 2)) >> 2] | 0) == (d | 0)) {
                                    e[(O + (n << 2)) >> 2] = e[(L + (a << 2)) >> 2];
                                    n = (n + 1) | 0;
                                }
                                a = (a + 1) | 0;
                        ...
                        qe[e[((e[(25648 + (e[f >> 2] << 2)) >> 2] | 0) + 24) >> 2] & 3](h, o, e[((e[M >> 2] | 0) + (S << 2)) >> 2] | 0, O, R, n, l, d) | 0;
                        d = (d + 1) | 0;
                    } while ((d | 0) < (e[y >> 2] | 0));
                }
                b = (K(o) | 0) != 0;
                if ((c | 0) < ((b ? 14 : 7) | 0)) c = (c + 1) | 0;
                else {
                    a = 0;
                    break;
                }
        ...
        function mi(l, s) {
            ...
            if ((t | 0) > 0) {
                ...
                o = 0;
                do {
                    t = e[(u + (e[(n + (o << 2)) >> 2] << 2)) >> 2] | 0;
                    t = y[e[((e[(25640 + (e[(v + 800 + (t << 2)) >> 2] << 2)) >> 2] | 0) + 20) >> 2] & 15](l, e[((e[h >> 2] | 0) + (t << 2)) >> 2] | 0) | 0;
                    e[(R + (o << 2)) >> 2] = t;
                    e[(_ + (o << 2)) >> 2] = ((t | 0) != 0) & 1;
                    w(e[((e[l >> 2] | 0) + (o << 2)) >> 2] | 0, 0, a | 0) | 0;
                    o = (o + 1) | 0;
                    t = e[c >> 2] | 0;
                } while ((o | 0) < (t | 0));
            }
            ...
            if ((e[s >> 2] | 0) > 0) {
                ...
                while (1) {
                    if ((t | 0) > 0) {
                        ...
                        do {
                            if ((e[(g + (o << 2)) >> 2] | 0) == (n | 0)) {
                                e[(k + (f << 2)) >> 2] = ((e[(_ + (o << 2)) >> 2] | 0) != 0) & 1;
                                e[(m + (f << 2)) >> 2] = e[((e[l >> 2] | 0) + (o << 2)) >> 2];
                                t = e[c >> 2] | 0;
                                f = (f + 1) | 0;
                            }
                            o = (o + 1) | 0;
                    ...
                    a = e[(M + (n << 2)) >> 2] | 0;
                    Se[e[((e[(25648 + (e[(v + 1312 + (a << 2)) >> 2] << 2)) >> 2] | 0) + 28) >> 2] & 7](l, e[((e[F >> 2] | 0) + (a << 2)) >> 2] | 0, m, k, t) | 0;
                    n = (n + 1) | 0;
                    if ((n | 0) >= (e[s >> 2] | 0)) break;
                    t = e[c >> 2] | 0;
                }
                t = e[S >> 2] | 0;
            } else t = o;
            if ((t | 0) > 0) {
                ...
                do {
                    a = t;
                    t = (t + -1) | 0;
                    f = e[(g + (e[(S + (t << 2)) >> 2] << 2)) >> 2] | 0;
                    o = e[(g + (e[(F + (t << 2)) >> 2] << 2)) >> 2] | 0;
                    if (k) {
                        m = 0;
                        do {
                            n = (f + (m << 2)) | 0;
            ...
            n = 0;
            do {
                a = e[(h + (e[(t + (n << 2)) >> 2] << 2)) >> 2] | 0;
                de[e[((e[(25640 + (e[(v + 800 + (a << 2)) >> 2] << 2)) >> 2] | 0) + 24) >> 2] & 3](l, e[((e[u >> 2] | 0) + (a << 2)) >> 2] | 0, e[(R + (n << 2)) >> 2] | 0, e[((e[l >> 2] | 0) + (n << 2)) >> 2] | 0) | 0;
                n = (n + 1) | 0;
                a = e[c >> 2] | 0;
            } while ((n | 0) < (a | 0));
            if ((a | 0) <= 0) {
        ...
        function ve(l, t) {
            ...
            o = 3.141592653589793 / +(t | 0);
            p = 3.141592653589793 / +((t << 1) | 0);
            n = 0;
            do {
                d = o * +((n << 2) | 0);
                f = n << 1;
        ...
        function vi(s, a, v) {
            ...
            while (1) {
                ...
                h = (o + 12) | 0;
                m = (o + 8) | 0;
                r[i >> 2] = -(+r[c >> 2] * +r[h >> 2]) - +r[m >> 2] * +r[t >> 2];
                r[(E + -12) >> 2] = +r[h >> 2] * +r[t >> 2] - +r[m >> 2] * +r[c >> 2];
                c = (t + 24) | 0;
                m = (o + 4) | 0;
                h = (t + 16) | 0;
                r[(E + -8) >> 2] = -(+r[c >> 2] * +r[m >> 2]) - +r[o >> 2] * +r[h >> 2];
                r[(E + -4) >> 2] = +r[m >> 2] * +r[h >> 2] - +r[o >> 2] * +r[c >> 2];
                t = (t + -32) | 0;
                if (t >>> 0 < a >>> 0) break;
                else o = (o + 16) | 0;
            }
            ...
            while (1) {
                ...
                c = (t + 24) | 0;
                m = (o + -8) | 0;
                r[i >> 2] = +r[m >> 2] * +r[c >> 2] + +r[n >> 2] * +r[h >> 2];
                r[(i + 4) >> 2] = +r[m >> 2] * +r[h >> 2] - +r[n >> 2] * +r[c >> 2];
                c = (o + -12) | 0;
                o = (o + -16) | 0;
                n = (t + 8) | 0;
                r[(i + 8) >> 2] = +r[o >> 2] * +r[n >> 2] + +r[c >> 2] * +r[t >> 2];
                r[(i + 12) >> 2] = +r[o >> 2] * +r[t >> 2] - +r[c >> 2] * +r[n >> 2];
                t = (t + -32) | 0;
                if (t >>> 0 < a >>> 0) break;
                else i = (i + 16) | 0;
            }
            Ke(e[(s + 4) >> 2] | 0, l, E, p);
            Ge(e[s >> 2] | 0, e[u >> 2] | 0, e[(s + 12) >> 2] | 0, v);
            t = ((e[u >> 2] | 0) + (p << 2)) | 0;
            i = v;
            n = w;
            o = w;
            while (1) {
                a = (t + 4) | 0;
                l = (i + 4) | 0;
                r[(n + -4) >> 2] = +r[a >> 2] * +r[i >> 2] - +r[t >> 2] * +r[l >> 2];
                r[o >> 2] = -(+r[t >> 2] * +r[i >> 2] + +r[a >> 2] * +r[l >> 2]);
                l = (i + 8) | 0;
                a = (t + 12) | 0;
                s = (i + 12) | 0;
                u = (t + 8) | 0;
                r[(n + -8) >> 2] = +r[a >> 2] * +r[l >> 2] - +r[u >> 2] * +r[s >> 2];
                r[(o + 4) >> 2] = -(+r[u >> 2] * +r[l >> 2] + +r[a >> 2] * +r[s >> 2]);
                s = (i + 16) | 0;
                a = (t + 20) | 0;
                l = (i + 20) | 0;
                u = (t + 16) | 0;
                r[(n + -12) >> 2] = +r[a >> 2] * +r[s >> 2] - +r[u >> 2] * +r[l >> 2];
                n = (n + -16) | 0;
                r[(o + 8) >> 2] = -(+r[u >> 2] * +r[s >> 2] + +r[a >> 2] * +r[l >> 2]);
                l = (i + 24) | 0;
                a = (t + 28) | 0;
                s = (i + 28) | 0;
                u = (t + 24) | 0;
                r[n >> 2] = +r[a >> 2] * +r[l >> 2] - +r[u >> 2] * +r[s >> 2];
                r[(o + 12) >> 2] = -(+r[u >> 2] * +r[l >> 2] + +r[a >> 2] * +r[s >> 2]);
                i = (i + 32) | 0;
                if (i >>> 0 >= n >>> 0) break;
                else {
                    t = (t + 32) | 0;
        ...
        function Xe(w, m, y) {
            ...
            if ((l | 0) > 0) {
                ...
                while (1) {
                    ...
                    c = +r[(o + 8) >> 2] + +r[a >> 2];
                    f = (f + -4) | 0;
                    r[(u + ((t + s) << 2)) >> 2] = +r[n >> 2] * d + c * +r[f >> 2];
                    r[(u + (((t | 1) + s) << 2)) >> 2] = +r[n >> 2] * c - +r[f >> 2] * d;
                    t = (t + 2) | 0;
                    if ((t | 0) >= (l | 0)) break;
                    else o = (o + 16) | 0;
                }
            ...
            if ((t | 0) < (h | 0)) {
                ...
                while (1) {
                    ...
                    c = +r[a >> 2] - +r[(o + 8) >> 2];
                    v = (v + -4) | 0;
                    r[(u + ((t + s) << 2)) >> 2] = +r[n >> 2] * d + c * +r[v >> 2];
                    r[(u + (((t | 1) + s) << 2)) >> 2] = +r[n >> 2] * c - +r[v >> 2] * d;
                    t = (t + 2) | 0;
                    if ((t | 0) >= (h | 0)) break;
                    else o = (o + 16) | 0;
                }
            ...
            Ke(e[(w + 4) >> 2] | 0, _, M, s);
            Ge(e[w >> 2] | 0, e[g >> 2] | 0, e[(w + 12) >> 2] | 0, u);
            if ((b | 0) <= 0) {
                i = k;
                return;
            }
            ...
            while (1) {
                ...
                f = (u + 4) | 0;
                l = (t + 4) | 0;
                r[(y + (a << 2)) >> 2] = (+r[l >> 2] * +r[f >> 2] + +r[t >> 2] * +r[u >> 2]) * +r[o >> 2];
                r[n >> 2] = (+r[l >> 2] * +r[u >> 2] - +r[t >> 2] * +r[f >> 2]) * +r[o >> 2];
                a = (a + 1) | 0;
                if ((a | 0) == (b | 0)) break;
                else {
                    t = (t + 8) | 0;
        ...
        function Ke(t, H, a, j) {
            ...
            if ((t | 0) > 6) {
                ...
                while (1) {
                    ...
                    r[p >> 2] = +r[v >> 2] + o;
                    p = (t + 4) | 0;
                    r[M >> 2] = +r[t >> 2] * n + +r[p >> 2] * s;
                    r[v >> 2] = +r[t >> 2] * s - +r[p >> 2] * n;
                    v = (F + 16) | 0;
                    n = +r[v >> 2];
                    p = (m + 16) | 0;
                    s = +r[p >> 2];
                    ...
                    M = (t + 20) | 0;
                    v = (t + 16) | 0;
                    r[p >> 2] = +r[v >> 2] * o + +r[M >> 2] * e;
                    r[b >> 2] = +r[v >> 2] * e - +r[M >> 2] * o;
                    b = (F + 8) | 0;
                    o = +r[b >> 2];
                    M = (m + 8) | 0;
                    e = +r[M >> 2];
                    ...
                    v = (t + 36) | 0;
                    b = (t + 32) | 0;
                    r[M >> 2] = +r[b >> 2] * i + +r[v >> 2] * s;
                    r[p >> 2] = +r[b >> 2] * s - +r[v >> 2] * i;
                    i = +r[F >> 2];
                    s = +r[m >> 2];
                    n = i - s;
                    p = (F + 4) | 0;
                    ...
                    p = (t + 52) | 0;
                    b = (t + 48) | 0;
                    r[m >> 2] = +r[b >> 2] * n + +r[p >> 2] * e;
                    r[v >> 2] = +r[b >> 2] * e - +r[p >> 2] * n;
                    m = (m + -32) | 0;
                    if (m >>> 0 < a >>> 0) break;
                    else {
                        t = (t + 64) | 0;
                    ...
                    if ((N | 0) != 31) {
                        ...
                        do {
                            ...
                            while (1) {
                                ...
                                r[k >> 2] = +r[D >> 2] + o;
                                k = (m + 4) | 0;
                                r[g >> 2] = +r[m >> 2] * n + +r[k >> 2] * s;
                                r[D >> 2] = +r[m >> 2] * s - +r[k >> 2] * n;
                                D = (m + (C << 2)) | 0;
                                k = (A + 16) | 0;
                                n = +r[k >> 2];
                                g = (y + 16) | 0;
                                ...
                                r[R >> 2] = +r[O >> 2] + i;
                                R = (m + (z << 2)) | 0;
                                r[g >> 2] = +r[D >> 2] * o + +r[R >> 2] * e;
                                r[O >> 2] = +r[D >> 2] * e - +r[R >> 2] * o;
                                O = (m + (W << 2)) | 0;
                                R = (A + 8) | 0;
                                o = +r[R >> 2];
                                D = (y + 8) | 0;
                                ...
                                r[g >> 2] = +r[k >> 2] + n;
                                g = (m + (q << 2)) | 0;
                                r[D >> 2] = +r[O >> 2] * i + +r[g >> 2] * s;
                                r[k >> 2] = +r[O >> 2] * s - +r[g >> 2] * i;
                                k = (m + (M << 2)) | 0;
                                i = +r[A >> 2];
                                s = +r[y >> 2];
                                n = i - s;
                                ...
                                r[g >> 2] = +r[O >> 2] + o;
                                g = (m + (b << 2)) | 0;
                                r[y >> 2] = +r[k >> 2] * n + +r[g >> 2] * e;
                                r[O >> 2] = +r[k >> 2] * e - +r[g >> 2] * n;
                                y = (y + -32) | 0;
                                if (y >>> 0 < V >>> 0) break;
                                else {
                                    m = (m + (p << 2)) | 0;
            ...
            do {
                ...
                r[V >> 2] = e + u;
                r[H >> 2] = w + l;
                r[R >> 2] = d * 0.9238795042037964 - h * 0.3826834261417389;
                r[b >> 2] = h * 0.9238795042037964 + d * 0.3826834261417389;
                I = (a + ((t | 26) << 2)) | 0;
                d = +r[I >> 2];
                k = (a + ((t | 10) << 2)) | 0;
                h = +r[k >> 2];
                ...
                r[I >> 2] = h + d;
                r[A >> 2] = u + w;
                r[k >> 2] = (l - e) * 0.7071067690849304;
                r[g >> 2] = (e + l) * 0.7071067690849304;
                N = (a + ((t | 24) << 2)) | 0;
                l = +r[N >> 2];
                D = (a + ((t | 8) << 2)) | 0;
                e = +r[D >> 2];
                ...
                r[N >> 2] = e + l;
                r[y >> 2] = d + u;
                u = w * 0.3826834261417389 - h * 0.9238795042037964;
                w = h * 0.3826834261417389 + w * 0.9238795042037964;
                M = (a + ((t | 22) << 2)) | 0;
                h = +r[M >> 2];
                Z = (a + ((t | 6) << 2)) | 0;
                d = +r[Z >> 2];
                ...
                r[q >> 2] = E + e;
                r[x >> 2] = n + d;
                d = _ * 0.9238795042037964 + h * 0.3826834261417389;
                h = _ * 0.3826834261417389 - h * 0.9238795042037964;
                J = (a + ((t | 2) << 2)) | 0;
                _ = +r[J >> 2];
                z = (a + ((t | 18) << 2)) | 0;
                n = +r[z >> 2];
                ...
                n = T + n;
                r[m >> 2] = n;
                T = c * 0.3826834261417389 + _ * 0.9238795042037964;
                _ = c * 0.9238795042037964 - _ * 0.3826834261417389;
                c = _ - w;
                i = T - u;
                u = T + u;
                w = _ + w;
                ...
                l = c + T;
                T = c - T;
                c = (Y + _) * 0.7071067690849304;
                _ = (Y - _) * 0.7071067690849304;
                r[Z >> 2] = c + l;
                r[$ >> 2] = l - c;
                c = (s - i) * 0.7071067690849304;
                l = L - P;
                r[Q >> 2] = c + T;
                r[J >> 2] = T - c;
                i = (s + i) * 0.7071067690849304;
                P = L + P;
                r[ee >> 2] = l + _;
                r[ie >> 2] = l - _;
                r[K >> 2] = P + i;
                ...
                c = L + B;
                B = L - B;
                L = (_ + w) * 0.7071067690849304;
                w = (_ - w) * 0.7071067690849304;
                r[M >> 2] = L + c;
                r[q >> 2] = c - L;
                L = (d - i) * 0.7071067690849304;
                c = T - E;
                r[W >> 2] = L + B;
                r[z >> 2] = B - L;
                i = (d + i) * 0.7071067690849304;
                E = T + E;
                r[O >> 2] = c + w;
                r[m >> 2] = c - w;
                r[F >> 2] = E + i;
        ...
        function lr(m, v, c, s, w) {
            ...
            p = e[c >> 2] | 0;
            e[(m + 36) >> 2] = p;
            h = ~~(+F(+D(+(+(p | 0) * 8)) * 1.4426950408889634) + -1);
            k = (m + 32) | 0;
            e[k >> 2] = h;
            l = +(w | 0);
            a = +(s | 0);
            d = +((1 << (h + 1)) | 0);
            p = ~~(d * (+D(+((l * 0.25 * 0.5) / a)) * 1.4426950216293335 + -5.965784072875977) - +(p | 0));
            e[(m + 28) >> 2] = p;
            e[(m + 40) >> 2] = 1 - p + ~~(d * (+D(+(((+(s | 0) + 0.25) * l * 0.5) / a)) * 1.4426950216293335 + -5.965784072875977) + 0.5);
            p = s << 2;
            h = u(p) | 0;
            e[(m + 16) >> 2] = h;
            g = u(p) | 0;
            ...
            do
                if ((w | 0) >= 26e3) {
                    if ((w | 0) < 38e3) {
                        r[i >> 2] = 0.9399999976158142;
                        break;
                    }
                    if ((w | 0) > 46e3) r[i >> 2] = 1.274999976158142;
                } else r[i >> 2] = 0;
            while (0);
            R = a * 2;
            _ = +(w | 0);
            ...
            e: while (1) {
                ...
                while (1) {
                    i = t;
                    t = (t + 1) | 0;
                    o = ~~+F((R * +C(+(+(t | 0) * 0.08664337545633316 + 2.7488713472395148))) / _);
                    if (!(((o | 0) <= (c | 0)) | n)) break;
                    if ((t | 0) >= 87) {
                        i = c;
                        break e;
            ...
            if (S) {
                ...
                do {
                    t = f(c, E) | 0;
                    l = +(t | 0);
                    l = +H(+(+(f(t, t) | 0) * 1.8499999754340024e-8)) * 2.240000009536743 + +H(+(l * 0.0007399999885819852)) * 13.100000381469727 + l * 9999999747378752e-20;
                    e: do
                        if (((b + o) | 0) < (E | 0)) {
                            d = l - +r[h >> 2];
                            do {
                                t = f(o, c) | 0;
                                O = +(t | 0);
                                if (!(+H(+(O * 0.0007399999885819852)) * 13.100000381469727 + O * 9999999747378752e-20 + +H(+(+(f(t, t) | 0) * 1.8499999754340024e-8)) * 2.240000009536743 < d)) break e;
                                o = (o + 1) | 0;
                            } while (((b + o) | 0) < (E | 0));
                        }
                    while (0);
                            ...
                            while (1) {
                                if (
                                    (t | 0) >= (n | 0)
                                        ? ((i = f(t, c) | 0),
                                            (d = +(i | 0)),
                                            (d = +H(+(d * 0.0007399999885819852)) * 13.100000381469727 + d * 9999999747378752e-20 + +H(+(+(f(i, i) | 0) * 1.8499999754340024e-8)) * 2.240000009536743),
                                            !(d < +r[w >> 2] + l))
                                        : 0
                                ) {
                                    i = t;
                ...
                if (S) {
                    ...
                    i = 0;
                    do {
                        e[(g + (i << 2)) >> 2] = ~~(d * (+D(+((l * (+(i | 0) + 0.25)) / a)) * 1.4426950216293335 + -5.965784072875977) + 0.5);
                        i = (i + 1) | 0;
                    } while ((i | 0) != (s | 0));
                } else A = 19;
            } else A = 19;
            if ((A | 0) == 19) l = _ * 0.5;
            e[(m + 8) >> 2] = Ni((v + 36) | 0, l / a, s, +r[(v + 24) >> 2], +r[(v + 28) >> 2]) | 0;
            n = u(12) | 0;
            e[(m + 12) >> 2] = n;
            e[n >> 2] = u(p) | 0;
            e[(n + 4) >> 2] = u(p) | 0;
            ...
            n = 0;
            do {
                a = +D(+(((+(n | 0) + 0.5) * _) / R)) * 2.885390043258667 + -11.931568145751953;
                a = a < 0 ? 0 : a;
                a = a >= 16 ? 16 : a;
                h = ~~a;
                a = a - +(h | 0);
                l = 1 - a;
                w = (h + 1) | 0;
                r[(t + (n << 2)) >> 2] = +r[(i + 132 + (w << 2)) >> 2] * a + +r[(i + 132 + (h << 2)) >> 2] * l;
                r[(o + (n << 2)) >> 2] = +r[(i + 200 + (w << 2)) >> 2] * a + +r[(i + 200 + (h << 2)) >> 2] * l;
                r[(c + (n << 2)) >> 2] = +r[(i + 268 + (w << 2)) >> 2] * a + +r[(i + 268 + (h << 2)) >> 2] * l;
                n = (n + 1) | 0;
            } while ((n | 0) != (s | 0));
            return;
        }
        function Ze(o) {
            ...
            if (t) {
                ...
                while (1) {
                    n(e[e[(t + (r << 2)) >> 2] >> 2] | 0);
                    n(e[((e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0) + 4) >> 2] | 0);
                    n(e[((e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0) + 8) >> 2] | 0);
                    n(e[((e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0) + 12) >> 2] | 0);
                    n(e[((e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0) + 16) >> 2] | 0);
                    n(e[((e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0) + 20) >> 2] | 0);
                    n(e[((e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0) + 24) >> 2] | 0);
                    n(e[((e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0) + 28) >> 2] | 0);
                    n(e[((e[i >> 2] | 0) + (r << 2)) >> 2] | 0);
                    r = (r + 1) | 0;
                    if ((r | 0) == 17) break;
                    t = e[i >> 2] | 0;
        ...
        function Je(n, l, f) {
            ...
            i = (i + ((((1 * (s << 2)) | 0) + 15) & -16)) | 0;
            a = (n + 24) | 0;
            $e(s, e[a >> 2] | 0, l, f, 140, -1);
            o = (s | 0) > 0;
            if (o) {
                t = 0;
                do {
                    r[(u + (t << 2)) >> 2] = +r[(l + (t << 2)) >> 2] - +r[(f + (t << 2)) >> 2];
                    t = (t + 1) | 0;
                } while ((t | 0) != (s | 0));
            }
            n = (n + 4) | 0;
            $e(s, e[a >> 2] | 0, u, f, 0, e[((e[n >> 2] | 0) + 128) >> 2] | 0);
            if (o) t = 0;
            else {
                i = c;
                return;
            ...
            do {
                ...
                o = ~~(+r[a >> 2] + 0.5);
                o = (o | 0) > 39 ? 39 : o;
                r[a >> 2] = +r[(n + 336 + (((o | 0) < 0 ? 0 : o) << 2)) >> 2] + +r[(u + (t << 2)) >> 2];
                t = (t + 1) | 0;
            } while ((t | 0) != (s | 0));
            i = c;
            return;
        }
        function Qe(u, M, E, n, t) {
            u = u | 0;
            M = M | 0;
            E = E | 0;
            n = +n;
                        ...
                        if (
                            t + 6 > +r[(E + (a << 2)) >> 2]
                                ? ((m = w >> e[c >> 2]),
                                    (m = (m | 0) > 16 ? 16 : m),
                                    (y = e[f >> 2] | 0),
                                    (d = ~~((b + t + -30) * 0.10000000149011612)),
                                    (d = (d | 0) < 0 ? 0 : d),
                                    (d = e[((e[(h + (((m | 0) < 0 ? 0 : m) << 2)) >> 2] | 0) + (((d | 0) > 7 ? 7 : d) << 2)) >> 2] | 0),
                                    (m = ~~+r[(d + 4) >> 2]),
                                    (F = +r[d >> 2]),
                                    (A = ~~F),
                                (A | 0) < (m | 0))
                            ...
                            l = A;
                            a = ~~((F + -16) * +(y | 0) - +((y >> 1) | 0) + +(((e[(_ + (a << 2)) >> 2] | 0) - (e[s >> 2] | 0)) | 0));
                            do {
                                if ((a | 0) > 0 ? ((R = +r[(d + ((l + 2) << 2)) >> 2] + t), (O = (v + (a << 2)) | 0), +r[O >> 2] < R) : 0) r[O >> 2] = R;
                                a = (a + y) | 0;
                                l = (l + 1) | 0;
                            } while (((l | 0) < (m | 0)) & ((a | 0) < (S | 0)));
                        }
                        if (!p) break;
                    }
                } else g = 7;
        ...
        function U(i, u, f, o, c, d, m) {
            ...
            do {
                ...
                if (o) {
                    n = t - +r[(m + (i << 2)) >> 2];
                    t = n + 17.200000762939453;
                    if (n > -17.200000762939453) {
                        t = 1 - v * t;
                        if (t < 0) t = 9999999747378752e-20;
                    } else t = 1 - s * t;
                    l = (d + (i << 2)) | 0;
                    r[l >> 2] = +r[l >> 2] * t;
                }
        ...
        function Oi(i, t) {
            ...
            n = e[(t + 4) >> 2] | 0;
            o = e[(n + 28) >> 2] | 0;
            i = +r[(o + 2936) >> 2] * (+(((e[(o + (e[(t + 40) >> 2] << 2)) >> 2] | 0) / 2) | 0 | 0) / +(e[(n + 8) >> 2] | 0)) + i;
            return +(i < -9999 ? -9999 : i);
        }
        function Ti(l, h, n, T, Z, z, L, K, F) {
            l = l | 0;
            h = h | 0;
            n = n | 0;
            T = T | 0;
            ...
            I = e[(h + 132 + (((e[n >> 2] | 0) * 60) | 0) + (l << 2)) >> 2] | 0;
            $ = +t[(1624 + (e[(h + 252 + (l << 2)) >> 2] << 3)) >> 3];
            R = F << 2;
            b = i;
            i = (i + ((((1 * R) | 0) + 15) & -16)) | 0;
            y = i;
            ...
            i = (i + ((((1 * R) | 0) + 15) & -16)) | 0;
            U = (T + 1156) | 0;
            ee = +t[(((N | 0) > 1e3 ? 1696 : 1624) + (e[(h + 312 + (l << 2)) >> 2] << 3)) >> 3];
            B = f(R, E) | 0;
            n = i;
            i = (i + ((((1 * B) | 0) + 15) & -16)) | 0;
            e[b >> 2] = n;
            ...
            i = (i + ((((1 * B) | 0) + 15) & -16)) | 0;
            e[g >> 2] = m;
            if ((F | 0) > 1 ? ((e[(b + 4) >> 2] = n + (E << 2)), (e[(y + 4) >> 2] = l + (E << 2)), (e[(M + 4) >> 2] = h + (E << 2)), (e[(g + 4) >> 2] = m + (E << 2)), (F | 0) != 2) : 0) {
                n = 2;
                do {
                    j = e[y >> 2] | 0;
                    C = e[M >> 2] | 0;
                        ...
                        do {
                            ...
                            if (!(e[(q + (o << 2)) >> 2] | 0)) {
                                if (S) {
                                    ...
                                    u = 0;
                                    do {
                                        r[(n + (u << 2)) >> 2] = 1.000000013351432e-10;
                                        r[(l + (u << 2)) >> 2] = 0;
                                        r[(h + (u << 2)) >> 2] = 0;
                                        e[(m + (u << 2)) >> 2] = 0;
                                        e[(v + ((u + p) << 2)) >> 2] = 0;
                                ...
                                if (S) {
                                    n = 0;
                                    do {
                                        e[(a + (n << 2)) >> 2] = e[(1768 + (e[(v + ((n + p) << 2)) >> 2] << 2)) >> 2];
                                        n = (n + 1) | 0;
                                    } while ((n | 0) != (x | 0));
                                    v = e[(Z + (o << 2)) >> 2] | 0;
                                    n = e[(g + (o << 2)) >> 2] | 0;
                                    if (S) {
                                        ...
                                        do {
                                            c = +A(+(+r[(v + ((l + p) << 2)) >> 2]));
                                            e[(n + (l << 2)) >> 2] = !(c / +r[(a + (l << 2)) >> 2] < ((l | 0) >= (P | 0) ? ee : $)) & 1;
                                            l = (l + 1) | 0;
                                        } while ((l | 0) != (k | 0));
                                        if (S) {
                                            n = e[(b + (o << 2)) >> 2] | 0;
                                ...
                                +er(e[V >> 2] | 0, I, n, e[l >> 2] | 0, a, 0, p, k, s);
                            }
                            o = (o + 1) | 0;
                        } while ((o | 0) != (F | 0));
                    }
                                    ...
                                    do {
                                        do
                                            if ((o | 0) < (ae | 0)) {
                                                ...
                                                u = (n + (u << 2)) | 0;
                                                s = e[u >> 2] | 0;
                                                if ((((a | 0) > -1 ? a : (0 - a) | 0) | 0) > (((s | 0) > -1 ? s : (0 - s) | 0) | 0)) {
                                                    a = (a | 0) > 0 ? (a - s) | 0 : (s - a) | 0;
                                                    e[u >> 2] = a;
                                                    s = e[v >> 2] | 0;
                                                } else {
                                                    e[u >> 2] = (s | 0) > 0 ? (a - s) | 0 : (s - a) | 0;
                                                    e[v >> 2] = s;
                                                    a = e[u >> 2] | 0;
                                                }
                                                if ((a | 0) >= ((((s | 0) > -1 ? s : (0 - s) | 0) << 1) | 0)) {
                                                    e[u >> 2] = 0 - a;
                                                    e[v >> 2] = 0 - (e[v >> 2] | 0);
                                                }
                                            }
            ...
            do {
                h = (L + (e[(T + 1160 + (n << 2)) >> 2] << 2)) | 0;
                l = (T + 2184 + (n << 2)) | 0;
                if (!((e[h >> 2] | 0) == 0 ? (e[(L + (e[l >> 2] << 2)) >> 2] | 0) == 0 : 0)) {
                    e[h >> 2] = 1;
                    e[(L + (e[l >> 2] << 2)) >> 2] = 1;
                    m = e[U >> 2] | 0;
                }
        ...
        function Ni(m, R, h, E, k) {
            ...
            do {
                ...
                t = (2792 + ((c * 1344) | 0)) | 0;
                d((p + ((c * 1792) | 0) + 448) | 0, t | 0, 224) | 0;
                d((p + ((c * 1792) | 0) + 672) | 0, (2792 + ((c * 1344) | 0) + 224) | 0, 224) | 0;
                d((p + ((c * 1792) | 0) + 896) | 0, (2792 + ((c * 1344) | 0) + 448) | 0, 224) | 0;
                d((p + ((c * 1792) | 0) + 1120) | 0, (2792 + ((c * 1344) | 0) + 672) | 0, 224) | 0;
                d((p + ((c * 1792) | 0) + 1344) | 0, (2792 + ((c * 1344) | 0) + 896) | 0, 224) | 0;
                d((p + ((c * 1792) | 0) + 1568) | 0, (2792 + ((c * 1344) | 0) + 1120) | 0, 224) | 0;
                d((p + ((c * 1792) | 0)) | 0, t | 0, 224) | 0;
                d((p + ((c * 1792) | 0) + 224) | 0, t | 0, 224) | 0;
                if (v) {
                    s = 0;
                    do {
                        if (b) {
                            ...
                            do {
                                t = (16 - f) | 0;
                                l = +(((t | 0) > -1 ? t : (0 - t) | 0) | 0) * k + E;
                                l = l < 0 ? 0 : l;
                                t = (p + ((c * 1792) | 0) + ((s * 224) | 0) + (f << 2)) | 0;
                                r[t >> 2] = +r[t >> 2] + (l > 0 ? 0 : l);
                                f = (f + 1) | 0;
                            } while ((f | 0) != 56);
                        } else {
                    ...
                    do {
                        if (b) {
                            ...
                            do {
                                n = (16 - f) | 0;
                                t = (p + ((c * 1792) | 0) + ((s * 224) | 0) + (f << 2)) | 0;
                                r[t >> 2] = +r[t >> 2] + (+(((n | 0) > -1 ? n : (0 - n) | 0) | 0) * k + E);
                                f = (f + 1) | 0;
                            } while ((f | 0) != 56);
                        }
                        s = (s + 1) | 0;
                ...
                n = 0;
                do {
                    a = ((n | 0) < 2 ? 50 : 70 - +(n | 0) * 10) + l;
                    s = 0;
                    do {
                        t = (p + ((c * 1792) | 0) + ((n * 224) | 0) + (s << 2)) | 0;
                        r[t >> 2] = +r[t >> 2] + a;
                        s = (s + 1) | 0;
                    } while ((s | 0) != 56);
                    d((y + ((n * 224) | 0)) | 0, N | 0, 224) | 0;
                    a = 70 - +(n | 0) * 10;
                    s = 0;
                    do {
                        t = (y + ((n * 224) | 0) + (s << 2)) | 0;
            ...
            do {
                ...
                E = +(S | 0);
                k = E * 0.5;
                c = ~~+Y(+(+C(+(E * 0.34657350182533264 + 4.135165354540845)) / F));
                M = ~~+zr(+(+D(+(+(c | 0) * R + 1)) * 2.885390043258667 + -11.931568145751953));
                c = ~~+Y(+(+D(+(+((c + 1) | 0) * R)) * 2.885390043258667 + -11.931568145751953));
                M = (M | 0) > (S | 0) ? S : M;
                M = (M | 0) < 0 ? 0 : M;
                c = (c | 0) > 16 ? 16 : c;
                N = (M | 0) > (c | 0);
                ...
                do {
                    ...
                    if (!N) {
                        ...
                        while (1) {
                            ...
                            do {
                                a = +(f | 0) * 0.125 + l;
                                t = ~~(+C(+((a + 3.9032840728759766) * 0.6931470036506653)) / F);
                                s = ~~(+C(+((a + 4.028284072875977) * 0.6931470036506653)) / F + 1);
                                o = (t | 0) < 0 ? 0 : t;
                                o = (o | 0) > (h | 0) ? h : o;
                                o = (o | 0) < (n | 0) ? o : n;
                                g = (s | 0) < 0 ? 0 : s;
                                if ((o | 0) < (h | 0) ? (o | 0) < (((g | 0) > (h | 0) ? h : g) | 0) : 0) {
                                    a = +r[(p + ((v * 1792) | 0) + ((_ * 224) | 0) + (f << 2)) >> 2];
                                    n = ~((n | 0) < (h | 0) ? n : h);
                                    g = (t | 0) > 0 ? ~t : -1;
                                    g = (g | 0) < (n | 0) ? n : g;
                                    t = (s | 0) > 0 ? ~s : -1;
                    ...
                    if (y) {
                        ...
                        do {
                            l = +(f | 0) * 0.125 + k;
                            n = ~~(+C(+((l + 3.9032840728759766) * 0.6931470036506653)) / F);
                            s = ~~(+C(+((l + 4.028284072875977) * 0.6931470036506653)) / F + 1);
                            t = (n | 0) < 0 ? 0 : n;
                            t = (t | 0) > (h | 0) ? h : t;
                            t = (t | 0) < (o | 0) ? t : o;
                            v = (s | 0) < 0 ? 0 : s;
                            if ((t | 0) < (h | 0) ? (t | 0) < (((v | 0) > (h | 0) ? h : v) | 0) : 0) {
                                a = +r[(p + ((S * 1792) | 0) + ((_ * 224) | 0) + (f << 2)) >> 2];
                                v = ~((o | 0) < (h | 0) ? o : h);
                                n = (n | 0) > 0 ? ~n : -1;
                                n = (n | 0) < (v | 0) ? v : n;
                                v = (s | 0) > 0 ? ~s : -1;
                    ...
                    t = 0;
                    do {
                        f = ~~(+C(+((E + +(t | 0) * 0.125) * 0.6931470036506653)) / F);
                        do
                            if ((f | 0) >= 0)
                                if ((f | 0) < (h | 0)) {
                                    e[((e[o >> 2] | 0) + ((t + 2) << 2)) >> 2] = e[(A + (f << 2)) >> 2];
                                    break;
                                } else {
                                    r[((e[s >> 2] | 0) + ((t + 2) << 2)) >> 2] = -999;
                                    break;
                                }
                            else r[((e[n >> 2] | 0) + ((t + 2) << 2)) >> 2] = -999;
                        while (0);
                        t = (t + 1) | 0;
                    } while ((t | 0) != 56);
                    do
        ...
        function $e(m, w, s, y, g, k) {
            ...
            if ((l | 0) > -1) {
                ...
                do {
                    a = t & 65535;
                    t = (0 - l) | 0;
                    u = +r[(E + (t << 2)) >> 2] + +r[(E + (a << 2)) >> 2];
                    n = +r[(_ + (a << 2)) >> 2] - +r[(_ + (t << 2)) >> 2];
                    h = +r[(S + (t << 2)) >> 2] + +r[(S + (a << 2)) >> 2];
                    f = +r[(v + (t << 2)) >> 2] + +r[(v + (a << 2)) >> 2];
                    d = +r[(p + (a << 2)) >> 2] - +r[(p + (t << 2)) >> 2];
                    c = f * h - d * n;
                    f = d * u - f * n;
                    n = h * u - n * n;
                    u = (f * o + c) / n;
            ...
            if ((s | 0) < (m | 0)) {
                do {
                    a = t >> 16;
                    u = +r[(E + (s << 2)) >> 2] - +r[(E + (a << 2)) >> 2];
                    n = +r[(_ + (s << 2)) >> 2] - +r[(_ + (a << 2)) >> 2];
                    h = +r[(S + (s << 2)) >> 2] - +r[(S + (a << 2)) >> 2];
                    f = +r[(v + (s << 2)) >> 2] - +r[(v + (a << 2)) >> 2];
                    d = +r[(p + (s << 2)) >> 2] - +r[(p + (a << 2)) >> 2];
                    c = f * h - d * n;
                    f = d * u - f * n;
                    n = h * u - n * n;
                    u = (f * o + c) / n;
            ...
            if ((t | 0) > -1) {
                ...
                while (1) {
                    t = (0 - t) | 0;
                    o = +r[(E + (t << 2)) >> 2] + +r[(E + (l << 2)) >> 2];
                    n = +r[(_ + (l << 2)) >> 2] - +r[(_ + (t << 2)) >> 2];
                    u = +r[(S + (t << 2)) >> 2] + +r[(S + (l << 2)) >> 2];
                    f = +r[(v + (t << 2)) >> 2] + +r[(v + (l << 2)) >> 2];
                    h = +r[(p + (l << 2)) >> 2] - +r[(p + (t << 2)) >> 2];
                    d = f * u - h * n;
                    f = h * o - f * n;
                    n = u * o - n * n;
                    o = (f * c + d) / n - g;
            ...
            if ((t | 0) < (m | 0)) {
                ...
                while (1) {
                    a = (t - k) | 0;
                    o = +r[(E + (t << 2)) >> 2] - +r[(E + (a << 2)) >> 2];
                    n = +r[(_ + (t << 2)) >> 2] - +r[(_ + (a << 2)) >> 2];
                    u = +r[(S + (t << 2)) >> 2] - +r[(S + (a << 2)) >> 2];
                    f = +r[(v + (t << 2)) >> 2] - +r[(v + (a << 2)) >> 2];
                    h = +r[(p + (t << 2)) >> 2] - +r[(p + (a << 2)) >> 2];
                    d = f * u - h * n;
                    f = h * o - f * n;
                    n = u * o - n * n;
                    o = (f * c + d) / n - g;
        ...
        function Pi(c, a, f) {
                ...
                do
                    if ((n | 0) >= 2) {
                        ...
                        while (1) {
                            ...
                            if (!((n | 0) > 1 ? (o | 0) < (((e[(u + (s << 2)) >> 2] | 0) + a) | 0) : 0)) {
                                t = 12;
                                break;
                            }
                            t = (n + -2) | 0;
            ...
            d = 0;
            while (1) {
                if ((a | 0) < (o | 0) ? ((p = (a + 1) | 0), +r[(l + (p << 2)) >> 2] > +r[(l + (a << 2)) >> 2]) : 0) t = e[(u + (p << 2)) >> 2] | 0;
                else t = (v + (e[(u + (a << 2)) >> 2] | 0)) | 0;
                if ((d | 0) < (((t | 0) > (f | 0) ? f : t) | 0)) {
                    E = e[(l + (a << 2)) >> 2] | 0;
                    s = (t | 0) < (f | 0) ? t : f;
                    t = d;
                    do {
        ...
        function er(S, g, y, E, _, h, a, c, m) {
            ...
            i = (i + ((((1 * (c << 2)) | 0) + 15) & -16)) | 0;
            if (!(e[(S + 500) >> 2] | 0)) s = c;
            else s = ((e[(S + 504) >> 2] | 0) - a) | 0;
            if ((((s | 0) > (c | 0) ? c : s) | 0) > 0) {
                d = (h | 0) == 0;
                o = (s | 0) < (c | 0) ? s : c;
                n = 0;
                do {
                    if (!(!d ? (e[(h + (n << 2)) >> 2] | 0) != 0 : 0)) v = 9;
                    do
                        if ((v | 0) == 9) {
                            v = 0;
                            b = +r[(y + (n << 2)) >> 2] < 0;
                            l = +F(+Ye(+(+r[(E + (n << 2)) >> 2] / +r[(_ + (n << 2)) >> 2])));
                            if (b) {
                                e[(m + (n << 2)) >> 2] = ~~-l;
                                break;
                            } else {
            ...
            do {
                ...
                if (!(u >= w)) {
                    ...
                    u = u + -1;
                    s = ~~((e[p >> 2] = (e[(y + (n << 2)) >> 2] & -2147483648) | 1065353216), +r[p >> 2]);
                    l = +r[(_ + (n << 2)) >> 2];
                }
                e[(m + (n << 2)) >> 2] = s;
                r[d >> 2] = l;
                    ...
                    if ((c | 0) < (a | 0)) {
                        if (i) {
                            ...
                            do {
                                ...
                                if ((t | 0) >= (a | 0)) break e;
                                r = (r + 1) | 0;
                                if (!(e[((e[(d + 1824 + (t << 2)) >> 2] | 0) + 12) >> 2] | 0)) break e;
                            } while ((r | 0) < (u | 0));
                        }
                        r = e[(d + 1824 + (c << 2)) >> 2] | 0;
                        i = e[(r + 4) >> 2] | 0;
                ...
                do {
                    ...
                    if (t) {
                        ...
                        if ((t | 0) > 0) {
                            ...
                            do {
                                if (w & (1 << c)) {
                                    e[((e[o >> 2] | 0) + (c << 2)) >> 2] = (e[v >> 2] | 0) + (((e[(d + (l << 2)) >> 2] | 0) * 56) | 0);
                                    l = (l + 1) | 0;
                                }
                                c = (c + 1) | 0;
                            } while ((c | 0) != (t | 0));
                        ...
                        do {
                            ...
                            e: do
                                if (S) {
                                    r = 0;
                                    do {
                                        if ((i | 0) <= (e[(s + 2328 + (r << 2)) >> 2] | 0) ? ((t = e[(s + 2584 + (r << 2)) >> 2] | 0), ((t | 0) < 0) | ((o | 0) < (t | 0))) : 0) break e;
                                        r = (r + 1) | 0;
                                    } while ((r | 0) < (b | 0));
                                } else r = 0;
                            while (0);
                            e[((e[(v + (c << 2)) >> 2] | 0) + (d << 2)) >> 2] = r;
                            c = (c + 1) | 0;
                        } while ((c | 0) != (a | 0));
                    }
                    d = (d + 1) | 0;
                ...
                while (1) {
                    ...
                    e: do
                        if (S) {
                            r = 0;
                            do {
                                if ((n | 0) <= (e[(a + 2328 + (r << 2)) >> 2] | 0) ? (o | 0) <= (e[(a + 2584 + (r << 2)) >> 2] | 0) : 0) break e;
                                r = (r + 1) | 0;
                            } while ((r | 0) < (b | 0));
                        } else r = 0;
                    while (0);
        ...
        function Xi(t, n, w, i, a) {
            ...
            p = (n + 16) | 0;
            d = e[e[p >> 2] >> 2] | 0;
            r = (f(e[(t + 36) >> 2] | 0, a) | 0) >> 1;
            l = e[(o + 4) >> 2] | 0;
            r = (((l | 0) < (r | 0) ? l : r) - (e[o >> 2] | 0)) | 0;
            if ((r | 0) <= 0) return 0;
            u = ((r | 0) / (h | 0)) | 0;
            l = g(t, ((((d + -1 + u) | 0) / (d | 0)) | 0) << 2) | 0;
            e: do
                if ((a | 0) > 0) {
                    r = 0;
                    do {
                        if (e[(i + (r << 2)) >> 2] | 0) break e;
                        r = (r + 1) | 0;
                    } while ((r | 0) < (a | 0));
                } else r = 0;
            while (0);
                    ...
                    while (1) {
                        ...
                        if (S & ((t | 0) < (u | 0))) {
                            ...
                            do {
                                n = e[((e[r >> 2] | 0) + (i << 2)) >> 2] | 0;
                                if (
                                    (((e[(o + 24 + (n << 2)) >> 2] & k) | 0) != 0 ? ((m = e[((e[((e[y >> 2] | 0) + (n << 2)) >> 2] | 0) + (s << 2)) >> 2] | 0), (m | 0) != 0) : 0)
                                        ? ((n = f(t, h) | 0), (Br(m, w, ((e[o >> 2] | 0) + n) | 0, a, E, h) | 0) == -1)
                                        : 0
                                ) {
                                    r = 23;
                                    break e;
                        ...
                        r: do
                            if (O & ((t | 0) < (u | 0))) {
                                ...
                                do {
                                    ...
                                    do {
                                        n = ((e[s >> 2] | 0) + o) | 0;
                                        r = e[((e[((e[(v + (d << 2)) >> 2] | 0) + (m << 2)) >> 2] | 0) + (w << 2)) >> 2] | 0;
                                        if (
                                            (((e[(s + 24 + (r << 2)) >> 2] & F) | 0) != 0 ? ((M = e[((e[((e[P >> 2] | 0) + (r << 2)) >> 2] | 0) + (c << 2)) >> 2] | 0), (M | 0) != 0) : 0)
                                                ? (de[b & 3](M, ((e[(k + (d << 2)) >> 2] | 0) + (n << 2)) | 0, _, p) | 0) == -1
                                                : 0
                                        ) {
                                            r = 25;
                                            break e;
                            ...
                            while (1) {
                                ...
                                if (Y) {
                                    ...
                                    do {
                                        ...
                                        if (((e[(y + 24 + (h << 2)) >> 2] & se) | 0) != 0 ? ((_ = e[((e[((e[oe >> 2] | 0) + (h << 2)) >> 2] | 0) + (M << 2)) >> 2] | 0), (_ | 0) != 0) : 0) {
                                            P = e[($ + (O << 2)) >> 2] | 0;
                                            q = e[_ >> 2] | 0;
                                            D = ((x | 0) / (q | 0)) | 0;
                                            if ((D | 0) > 0) {
                                                    ...
                                                    do
                                                        if ((k | 0) == 1) {
                                                            ...
                                                            do {
                                                                ...
                                                                u = e[(P + ((U + c) << 2)) >> 2] | 0;
                                                                n = (u - C) | 0;
                                                                if ((n | 0) < (E | 0)) n = (((E - n) << 1) + -1) | 0;
                                                                else n = (n - E) << 1;
                                                                r = f(r, d) | 0;
                                                                r = (((n | 0) < 0 ? 0 : (n | 0) >= (d | 0) ? v : n) + r) | 0;
                                                                e[(l + (c << 2)) >> 2] = u;
                                                                p = (p + 1) | 0;
                                                            } while ((p | 0) != (b | 0));
                                                        } else {
                                                            ...
                                                            do {
                                                                c = (c + -1) | 0;
                                                                t = (((v + (e[(P + ((U + c) << 2)) >> 2] | 0)) | 0) / (k | 0)) | 0;
                                                                if ((t | 0) < (E | 0)) u = (((E - t) << 1) + -1) | 0;
                                                                else u = (t - E) << 1;
                                                                r = f(r, d) | 0;
                                                                r = (((u | 0) < 0 ? 0 : (u | 0) >= (d | 0) ? n : u) + r) | 0;
                                                                e[(l + (c << 2)) >> 2] = (f(t, k) | 0) + C;
                                                                p = (p + 1) | 0;
                                                            } while ((p | 0) != (b | 0));
                                                        }
        ...
        function $i(n, u, y) {
            ...
            i = e[(n + 16) >> 2] | 0;
            _ = +((i & 2097151) | 0);
            _ = +ne((i | 0) < 0 ? -_ : _, (((i >>> 21) & 1023) + -788) | 0);
            i = e[(n + 20) >> 2] | 0;
            E = +((i & 2097151) | 0);
            E = +ne((i | 0) < 0 ? -E : E, (((i >>> 21) & 1023) + -788) | 0);
            i = e[n >> 2] | 0;
            u = h(f(i, u) | 0, 4) | 0;
            if ((t | 0) == 1) {
                b = e[(n + 4) >> 2] | 0;
                ...
                do {
                    if (k) {
                        ...
                        if (!(e[M >> 2] | 0)) {
                            ...
                            o = 0;
                            do {
                                r[(u + ((g + o) << 2)) >> 2] = _ + +A(+(+(e[(t + (((((w | 0) / (s | 0)) | 0 | 0) % (d | 0) | 0) << 2)) >> 2] | 0))) * E;
                                s = f(s, d) | 0;
                                o = (o + 1) | 0;
                            } while ((o | 0) < (i | 0));
                            v = 21;
                            ...
                            m = 0;
                            do {
                                m = m + _ + +A(+(+(e[(t + (((((w | 0) / (s | 0)) | 0 | 0) % (d | 0) | 0) << 2)) >> 2] | 0))) * E;
                                r[(u + ((g + o) << 2)) >> 2] = m;
                                s = f(s, d) | 0;
                                o = (o + 1) | 0;
                            } while ((o | 0) < (i | 0));
                        ...
                        p = 0;
                        while (1) {
                            m = p + _ + +A(+(+(e[(g + (((((w | 0) / (t | 0)) | 0 | 0) % (d | 0) | 0) << 2)) >> 2] | 0))) * E;
                            r[(u + ((o + S) << 2)) >> 2] = m;
                            t = f(t, d) | 0;
                            S = (S + 1) | 0;
                            if ((S | 0) >= (i | 0)) {
                ...
                do {
                    if (!(v ? (a[((e[w >> 2] | 0) + n) >> 0] | 0) == 0 : 0)) {
                        if (F) {
                            ...
                            m = 0;
                            while (1) {
                                p = m + _ + +A(+(+(e[(S + ((s + t) << 2)) >> 2] | 0))) * E;
                                if (v) r[(u + (((f(e[d >> 2] | 0, i) | 0) + t) << 2)) >> 2] = p;
                                else r[(u + ((o + t) << 2)) >> 2] = p;
                                t = (t + 1) | 0;
                                if ((t | 0) >= (i | 0)) break;
                                else m = g ? m : p;
        ...
        function nr(i, t) {
            ...
            while (1) {
                ...
                if (((a | 0) > (n | 0)) & ((l | 0) <= (n | 0))) break;
                r = (((l | 0) > (n | 0) ? -1 : 1) + r) | 0;
            }
            e[(i + 44) >> 2] = r;
            r = e[(t + 16) >> 2] | 0;
            s = +((r & 2097151) | 0);
            e[(i + 48) >> 2] = ~~+Ve(+ne((r | 0) < 0 ? -s : s, (((r >>> 21) & 1023) + -788) | 0));
            r = e[(t + 20) >> 2] | 0;
            s = +((r & 2097151) | 0);
            e[(i + 52) >> 2] = ~~+Ve(+ne((r | 0) < 0 ? -s : s, (((r >>> 21) & 1023) + -788) | 0));
            return 0;
        }
        function tt(c, p) {
            c = c | 0;
            ...
            do {
                ...
                r = ((r >>> 4) & 252645135) | ((r << 4) & -252645136);
                r = ((r >>> 2) & 858993459) | ((r << 2) & -858993460);
                e[l >> 2] = ((r >>> 1) & 1431655765) | ((r << 1) & -1431655766);
                e[(t + (f << 2)) >> 2] = l;
                f = (f + 1) | 0;
            } while ((f | 0) != (o | 0));
            Z(t, o, 4, 10);
            ...
            r = 0;
            do {
                e[(E + ((((e[(t + (r << 2)) >> 2] | 0) - l) >> 2) << 2)) >> 2] = r;
                r = (r + 1) | 0;
            } while ((r | 0) != (o | 0));
            r = 0;
            do {
                e[(f + (e[(E + (r << 2)) >> 2] << 2)) >> 2] = e[(d + (r << 2)) >> 2];
                r = (r + 1) | 0;
            } while ((r | 0) != (o | 0));
            n(d);
            e[(c + 16) >> 2] = $i(p, o, E) | 0;
                ...
                do {
                    ...
                    if (
                        (o | 0) >= (r | 0)
                            ? ((w = e[((e[g >> 2] | 0) + (s << 2)) >> 2] | 0),
                                (w = (w >>> 16) | (w << 16)),
                                (w = ((w >>> 8) & 16711935) | ((w << 8) & -16711936)),
                                (w = ((w >>> 4) & 252645135) | ((w << 4) & -252645136)),
                                (w = ((w >>> 2) & 858993459) | ((w << 2) & -858993460)),
                                (w = ((w >>> 1) & 1431655765) | ((w << 1) & -1431655766)),
                            ((o - r) | 0) != 31)
                            : 0
                    ) {
                        f = (s + 1) | 0;
            ...
            while (1) {
                l = t << (32 - o);
                s = (l >>> 16) | (l << 16);
                s = ((s >>> 8) & 16711935) | ((s << 8) & -16711936);
                s = ((s >>> 4) & 252645135) | ((s << 4) & -252645136);
                s = ((s >>> 2) & 858993459) | ((s << 2) & -858993460);
                s = (m + ((((s >>> 1) & 1431655765) | ((s << 1) & -1431655766)) << 2)) | 0;
                if (!(e[s >> 2] | 0)) {
                    o = r;
                    while (1) {
                        r = (o + 1) | 0;
                        if ((r | 0) >= (v | 0)) break;
                        if ((e[((e[g >> 2] | 0) + (r << 2)) >> 2] | 0) >>> 0 > l >>> 0) break;
                        else o = r;
                    }
                    e: do
                        if ((v | 0) > (f | 0)) {
                            r = e[g >> 2] | 0;
                            do {
                                if (l >>> 0 < (e[(r + (f << 2)) >> 2] & p) >>> 0) break e;
                                f = (f + 1) | 0;
                            } while ((v | 0) > (f | 0));
                        }
                    while (0);
                    r = (v - f) | 0;
                    e[s >> 2] = (o >>> 0 > 32767 ? -1073774592 : (o << 15) | -2147483648) | (r >>> 0 > 32767 ? 32767 : r);
                    r = o;
                }
                t = (t + 1) | 0;
                if ((t | 0) >= (_ | 0)) {
            ...
            do {
                ...
                do
                    if ((t | 0) == 2) {
                        ...
                        w = (i + ((d + l) << 2)) | 0;
                        if (!(((n | 0) == 1 ? r : c) | 0)) {
                            be(n, t, a, u, o, o, o, i, i, w);
                            r = 1;
                            break;
                        } else {
                            be(n, t, a, u, i, i, i, o, o, w);
                            r = 0;
                            break;
                        }
                    }
        ...
        function sr(e, b, o, n, N, T, R) {
            ...
            if (O) {
                ...
                while (1) {
                    ...
                    r[(n + ((g + l) << 2)) >> 2] = c - a;
                    l = (l + E) | 0;
                    r[(n + ((l + -1) << 2)) >> 2] = +r[_ >> 2] - +r[i >> 2];
                    r[(n + (l << 2)) >> 2] = +r[F >> 2] - +r[A >> 2];
                    h = (h + 1) | 0;
                    if ((h | 0) == (b | 0)) break;
                    else {
                        m = (m + e) | 0;
            ...
            while (1) {
                w = +r[(o + (h << 2)) >> 2];
                c = +r[(o + (t << 2)) >> 2];
                a = (c + w) * -0.7071067690849304;
                c = (w - c) * 0.7071067690849304;
                i = (o + ((d + -1) << 2)) | 0;
                r[(n + ((s + -1) << 2)) >> 2] = c + +r[i >> 2];
                _ = (s + g) | 0;
                r[(n + ((_ + -1) << 2)) >> 2] = +r[i >> 2] - c;
        ...
        function fr(i, h, s, l, _) {
            ...
            if (E) {
                ...
                while (1) {
                    ...
                    c = (s + (o << 2)) | 0;
                    u = t << 1;
                    r[(l + (u << 2)) >> 2] = +r[c >> 2] + +r[d >> 2];
                    r[(l + ((n + u) << 2)) >> 2] = +r[d >> 2] - +r[c >> 2];
                    a = (a + 1) | 0;
                    if ((a | 0) == (h | 0)) break;
                    else {
                        t = (t + i) | 0;
        ...
        function be(o, F, w, b, A, m, S, p, k, _) {
            o = o | 0;
            F = F | 0;
            w = w | 0;
            b = b | 0;
                                    ...
                                    do {
                                        ...
                                        if (g) {
                                            ...
                                            do {
                                                ...
                                                E = (_ + (a << 2)) | 0;
                                                O = (m + (c << 2)) | 0;
                                                r[(p + (U << 2)) >> 2] = +r[O >> 2] * +r[E >> 2] + +r[v >> 2] * +r[y >> 2];
                                                r[(p + (c << 2)) >> 2] = +r[O >> 2] * +r[y >> 2] - +r[v >> 2] * +r[E >> 2];
                                                u = (u + 2) | 0;
                                            } while ((u | 0) < (o | 0));
                                        }
                                        n = (n + 1) | 0;
                                ...
                                do {
                                    ...
                                    if (v) {
                                        ...
                                        while (1) {
                                            ...
                                            E = (m + (O << 2)) | 0;
                                            y = (m + (i << 2)) | 0;
                                            r[(p + (O << 2)) >> 2] = +r[y >> 2] * +r[u >> 2] + +r[E >> 2] * +r[h >> 2];
                                            r[(p + (i << 2)) >> 2] = +r[y >> 2] * +r[h >> 2] - +r[E >> 2] * +r[u >> 2];
                                            a = (a + 1) | 0;
                                            if ((a | 0) == (w | 0)) break;
                                            else i = (i + o) | 0;
                                        }
                                ...
                                while (1) {
                                    if (c) {
                                        ...
                                        do {
                                            ...
                                            s = (s + 2) | 0;
                                            _ = (p + (O << 2)) | 0;
                                            r[(m + (v << 2)) >> 2] = +r[_ >> 2] + +r[E >> 2];
                                            v = (p + (n << 2)) | 0;
                                            y = (p + (s << 2)) | 0;
                                            r[(m + (O << 2)) >> 2] = +r[v >> 2] - +r[y >> 2];
                                            r[(m + (n << 2)) >> 2] = +r[y >> 2] + +r[v >> 2];
                                            r[(m + (s << 2)) >> 2] = +r[_ >> 2] - +r[E >> 2];
                                            d = (d + 2) | 0;
                                        } while ((d | 0) < (o | 0));
                                    }
                                    u = (u + 1) | 0;
                ...
                do {
                    ...
                    if (h) {
                        ...
                        do {
                            ...
                            c = (p + (n << 2)) | 0;
                            l = (p + (s << 2)) | 0;
                            r[(m + (n << 2)) >> 2] = +r[l >> 2] + +r[c >> 2];
                            r[(m + (s << 2)) >> 2] = +r[l >> 2] - +r[c >> 2];
                            u = (u + 1) | 0;
                        } while ((u | 0) != (w | 0));
                    }
                    d = (d + 1) | 0;
                ...
                if (E) {
                    ...
                    do {
                        ...
                        if (_) {
                            ...
                            i = b;
                            while (1) {
                                r[(k + (d << 2)) >> 2] = +r[(S + (i << 2)) >> 2] * N + +r[(S + (h << 2)) >> 2];
                                r[(k + (u << 2)) >> 2] = +r[(S + (a << 2)) >> 2] * T;
                                h = (h + 1) | 0;
                                if ((h | 0) == (b | 0)) break;
                                else {
                                    d = (d + 1) | 0;
                        ...
                        if (g) {
                            ...
                            do {
                                ...
                                if (_) {
                                    ...
                                    while (1) {
                                        y = (k + (i << 2)) | 0;
                                        r[y >> 2] = +r[y >> 2] + +r[(S + (s << 2)) >> 2] * B;
                                        y = (k + (n << 2)) | 0;
                                        r[y >> 2] = +r[y >> 2] + +r[(S + (c << 2)) >> 2] * P;
                                        h = (h + 1) | 0;
                                        if ((h | 0) == (b | 0)) break;
                                        else {
                                            i = (i + 1) | 0;
                    ...
                    if (!u) {
                        ...
                        while (1) {
                            ...
                            do {
                                ...
                                b = (p + ((E + -1) << 2)) | 0;
                                h = (l + i) | 0;
                                r[(A + ((h + -1) << 2)) >> 2] = +r[b >> 2] + +r[F >> 2];
                                k = (o - l + n) | 0;
                                r[(A + ((k + -1) << 2)) >> 2] = +r[F >> 2] - +r[b >> 2];
                                S = (p + (S << 2)) | 0;
                                E = (p + (E << 2)) | 0;
                                r[(A + (h << 2)) >> 2] = +r[E >> 2] + +r[S >> 2];
                                r[(A + (k << 2)) >> 2] = +r[E >> 2] - +r[S >> 2];
                                l = (l + 2) | 0;
                            } while ((l | 0) < (o | 0));
                            c = (c + 1) | 0;
                            if ((c | 0) == (w | 0)) break;
                ...
                if (v ? ((z = (t + o) | 0), m) : 0) {
                    ...
                    do {
                        ...
                        while (1) {
                            S = (p + ((n + -1) << 2)) | 0;
                            k = (p + ((c + -1) << 2)) | 0;
                            r[(A + ((i + -1) << 2)) >> 2] = +r[k >> 2] + +r[S >> 2];
                            r[(A + ((a + -1) << 2)) >> 2] = +r[S >> 2] - +r[k >> 2];
                            k = (p + (n << 2)) | 0;
                            S = (p + (c << 2)) | 0;
                            r[(A + (i << 2)) >> 2] = +r[S >> 2] + +r[k >> 2];
                            r[(A + (a << 2)) >> 2] = +r[S >> 2] - +r[k >> 2];
                            d = (d + 1) | 0;
                            if ((d | 0) == (w | 0)) break;
                            else {
                                a = (a + D) | 0;
        ...
        function ct(D) {
            ...
            a = +t[x >> 3];
            A = ~~a;
            c = e[((e[(k + 24) >> 2] | 0) + (A << 2)) >> 2] | 0;
            A = e[((e[(k + 28) >> 2] | 0) + (A << 2)) >> 2] | 0;
            e[_ >> 2] = c;
            e[(_ + 4) >> 2] = A;
            A = (c | 0) == (A | 0);
            c = (k + 144) | 0;
                ...
                while (1) {
                    ...
                    if ((n | 0) > 0) {
                        ...
                        if ((s | 0) >= 0) {
                            ...
                            if ((n | 0) >= 0 ? ((M = e[e[(F + (C << 2)) >> 2] >> 2] | 0), (C = e[P >> 2] | 0), (e[P >> 2] = C + 1), (e[(S + 1824 + (C << 2)) >> 2] = M), (n | 0) != 0) : 0) {
                                s = 0;
                                do {
                                    s = (s + 1) | 0;
                                    M = e[((e[(F + (e[I >> 2] << 2)) >> 2] | 0) + (s << 2)) >> 2] | 0;
                                    C = e[P >> 2] | 0;
                                    e[P >> 2] = C + 1;
                                    e[(S + 1824 + (C << 2)) >> 2] = M;
                                } while ((s | 0) != (n | 0));
                    ...
                    F = (S + 16) | 0;
                    e[(S + 800 + (e[F >> 2] << 2)) >> 2] = 1;
                    e[(S + 1056 + (e[F >> 2] << 2)) >> 2] = T;
                    e[F >> 2] = (e[F >> 2] | 0) + 1;
                    i = (i + 1) | 0;
                    if ((i | 0) >= (e[c >> 2] | 0)) break;
                    a = +t[x >> 3];
                    S = e[B >> 2] | 0;
                }
                w = e[B >> 2] | 0;
            ...
            a = a - +(m | 0);
            v = (c + (m << 3)) | 0;
            d((w + 2868) | 0, (p + ((~~+t[v >> 3] * 492) | 0)) | 0, 492) | 0;
            a = +t[(c + ((m + 1) << 3)) >> 3] * a + +t[v >> 3] * (1 - a);
            v = ~~a;
            a = a - +(v | 0);
            m = ((v | 0) > 0) & (a == 0);
            a = m ? 1 : a;
            ...
            R = 1 - a;
            m = (v + 1) | 0;
            r[(w + 2872) >> 2] = R * +r[(p + ((v * 492) | 0) + 4) >> 2] + a * +r[(p + ((m * 492) | 0) + 4) >> 2];
            r[(w + 2900) >> 2] = R * +r[(p + ((v * 492) | 0) + 32) >> 2] + a * +r[(p + ((m * 492) | 0) + 32) >> 2];
            r[(w + 2876) >> 2] = R * +r[(p + ((v * 492) | 0) + 8) >> 2] + a * +r[(p + ((m * 492) | 0) + 8) >> 2];
            r[(w + 2904) >> 2] = +r[(p + ((m * 492) | 0) + 36) >> 2] * a + R * +r[(p + ((v * 492) | 0) + 36) >> 2];
            r[(w + 2880) >> 2] = +r[(p + ((m * 492) | 0) + 12) >> 2] * a + +r[(p + ((v * 492) | 0) + 12) >> 2] * R;
            r[(w + 2908) >> 2] = +r[(p + ((m * 492) | 0) + 40) >> 2] * a + +r[(p + ((v * 492) | 0) + 40) >> 2] * R;
            r[(w + 2884) >> 2] = +r[(p + ((m * 492) | 0) + 16) >> 2] * a + +r[(p + ((v * 492) | 0) + 16) >> 2] * R;
            r[(w + 2912) >> 2] = +r[(p + ((m * 492) | 0) + 44) >> 2] * a + +r[(p + ((v * 492) | 0) + 44) >> 2] * R;
            r[(w + 2936) >> 2] = +t[(w + 3512) >> 3];
            v = e[(k + 132) >> 2] | 0;
            R = +t[(_ + 3472) >> 3];
            p = ~~R;
            R = R - +(p | 0);
            ...
            e: do
                if (!v) {
                    ...
                    if (e[(_ + 3420) >> 2] | 0) {
                        ...
                        o = 0;
                        while (1) {
                            O = +r[(v + ((i * 240) | 0) + 120 + (o << 2)) >> 2] * R + +r[(v + ((p * 240) | 0) + 120 + (o << 2)) >> 2] * a;
                            W = (O * 1e3) / E;
                            e[(m + 3e3 + (o << 2)) >> 2] = ~~(+(e[m >> 2] | 0) * W);
                            e[(m + 3060 + (o << 2)) >> 2] = ~~(+(e[l >> 2] | 0) * W);
                            e[(m + 2940 + (o << 2)) >> 2] = ~~O;
                            O = ((+r[(v + ((i * 240) | 0) + 180 + (o << 2)) >> 2] * R + +r[(v + ((p * 240) | 0) + 180 + (o << 2)) >> 2] * a) * 1e3) / E;
                            e[(m + 3240 + (o << 2)) >> 2] = ~~(+(e[m >> 2] | 0) * O);
                            e[(m + 3300 + (o << 2)) >> 2] = ~~(+(e[l >> 2] | 0) * O);
                            o = (o + 1) | 0;
                            if ((o | 0) == 15) break e;
                        }
                    }
                    E = 1 - R;
                    n = (p + 1) | 0;
                    O = +r[(v + ((n * 240) | 0) + 148) >> 2] * R + +r[(v + ((p * 240) | 0) + 148) >> 2] * E;
                    l = (m + 4) | 0;
                    o = ~~O;
                    a = +(e[(D + 8) >> 2] | 0);
                    O = (O * 1e3) / a;
                    s = 0;
                    do {
                        e[(m + 3e3 + (s << 2)) >> 2] = ~~(+(e[m >> 2] | 0) * O);
                        e[(m + 3060 + (s << 2)) >> 2] = ~~(+(e[l >> 2] | 0) * O);
                        e[(m + 2940 + (s << 2)) >> 2] = o;
                        s = (s + 1) | 0;
                    } while ((s | 0) != 15);
                    a = ((+r[(v + ((n * 240) | 0) + 208) >> 2] * R + +r[(v + ((p * 240) | 0) + 208) >> 2] * E) * 1e3) / a;
                    i = 0;
                    do {
                        e[(m + 3240 + (i << 2)) >> 2] = ~~(+(e[m >> 2] | 0) * a);
                        e[(m + 3300 + (i << 2)) >> 2] = ~~(+(e[l >> 2] | 0) * a);
                        i = (i + 1) | 0;
                    } while ((i | 0) != 15);
                }
            while (0);
            ...
            l = (k + 32) | 0;
            w = (k + 36) | 0;
            ie(D, +t[(_ + 3528 + (H << 5)) >> 3], 0, e[l >> 2] | 0, e[w >> 2] | 0, e[(k + 44) >> 2] | 0);
            p = (k + 52) | 0;
            ie(D, +t[(_ + 3560) >> 3], 1, e[l >> 2] | 0, e[w >> 2] | 0, e[p >> 2] | 0);
            if (!A) {
                ie(D, +t[(_ + 3592) >> 3], 2, e[l >> 2] | 0, e[w >> 2] | 0, e[p >> 2] | 0);
                ie(D, +t[(_ + 3624) >> 3], 3, e[l >> 2] | 0, e[w >> 2] | 0, e[(k + 48) >> 2] | 0);
            }
            a = +t[(_ + 3528 + (H << 5) + 24) >> 3];
            v = e[(k + 80) >> 2] | 0;
            n = e[(k + 84) >> 2] | 0;
            ...
            l = 0;
            do {
                r[(b + 336 + (l << 2)) >> 2] = +(e[(v + ((o * 160) | 0) + (l << 2)) >> 2] | 0) * a + +(e[(v + ((i * 160) | 0) + (l << 2)) >> 2] | 0) * E;
                l = (l + 1) | 0;
            } while ((l | 0) != 40);
            a = +t[(_ + 3584) >> 3];
            i = ~~a;
            ...
            l = 0;
            do {
                r[(w + 336 + (l << 2)) >> 2] = +(e[(v + ((o * 160) | 0) + (l << 2)) >> 2] | 0) * a + +(e[(v + ((i * 160) | 0) + (l << 2)) >> 2] | 0) * E;
                l = (l + 1) | 0;
            } while ((l | 0) != 40);
            if (!A) {
                E = +t[(_ + 3616) >> 3];
                ...
                i = 0;
                do {
                    r[(s + 336 + (i << 2)) >> 2] = +(e[(v + ((o * 160) | 0) + (i << 2)) >> 2] | 0) * E + +(e[(v + ((n * 160) | 0) + (i << 2)) >> 2] | 0) * O;
                    i = (i + 1) | 0;
                } while ((i | 0) != 40);
                E = +t[(_ + 3648) >> 3];
                o = ~~E;
                ...
                i = 0;
                do {
                    r[(s + 336 + (i << 2)) >> 2] = +(e[(v + ((n * 160) | 0) + (i << 2)) >> 2] | 0) * E + +(e[(v + ((o * 160) | 0) + (i << 2)) >> 2] | 0) * a;
                    i = (i + 1) | 0;
                } while ((i | 0) != 40);
            }
            a = +t[(_ + 3528 + (H << 5) + 8) >> 3];
            ...
            c = ~~a;
            a = a - +(c | 0);
            r[(b + 32) >> 2] = +(e[(i + ((c + 1) << 2)) >> 2] | 0) * a + +(e[(i + (c << 2)) >> 2] | 0) * (1 - a);
            a = +t[(_ + 3568) >> 3];
            c = ~~a;
            a = a - +(c | 0);
            r[(w + 32) >> 2] = +(e[(i + ((c + 1) << 2)) >> 2] | 0) * a + +(e[(i + (c << 2)) >> 2] | 0) * (1 - a);
            if (!A) {
                a = +t[(_ + 3600) >> 3];
                c = ~~a;
                a = a - +(c | 0);
                r[((e[(M + 2860) >> 2] | 0) + 32) >> 2] = +(e[(i + ((c + 1) << 2)) >> 2] | 0) * a + +(e[(i + (c << 2)) >> 2] | 0) * (1 - a);
                a = +t[(_ + 3632) >> 3];
                c = ~~a;
                a = a - +(c | 0);
                r[((e[(M + 2864) >> 2] | 0) + 32) >> 2] = +(e[(i + ((c + 1) << 2)) >> 2] | 0) * a + +(e[(i + (c << 2)) >> 2] | 0) * (1 - a);
            }
            l = (k + 76) | 0;
            w = (k + 56) | 0;
            if (N) a = 0;
            else a = +t[(_ + 3408) >> 3];
            ee(D, +t[(_ + 3528 + (H << 5) + 16) >> 3], 0, e[l >> 2] | 0, e[(k + 60) >> 2] | 0, e[w >> 2] | 0, a);
            ee(D, +t[(_ + 3576) >> 3], 1, e[l >> 2] | 0, e[(k + 64) >> 2] | 0, e[w >> 2] | 0, 0);
            if (A) {
                N = e[B >> 2] | 0;
                c = e[(N + 2852) >> 2] | 0;
                E = +t[(N + 3496) >> 3];
                ...
                ee(D, +t[(_ + 3608) >> 3], 2, e[l >> 2] | 0, e[(k + 68) >> 2] | 0, e[w >> 2] | 0, 0);
                ee(D, +t[(_ + 3640) >> 3], 3, e[l >> 2] | 0, e[(k + 72) >> 2] | 0, e[w >> 2] | 0, 0);
                N = e[B >> 2] | 0;
                c = e[(N + 2852) >> 2] | 0;
                E = +t[(N + 3496) >> 3];
                r[(c + 4) >> 2] = E;
            ...
            do {
                ...
                e[(c + 8) >> 2] = e[(S + 8) >> 2];
                e[(c + 12) >> 2] = e[(S + 12) >> 2];
                if ((A | 0) >= (e[j >> 2] | 0)) e[j >> 2] = A + 1;
                e[(N + 288 + (A << 2)) >> 2] = 0;
                k = (q + ((A * 3208) | 0)) | 0;
                d(e[i >> 2] | 0, k | 0, 3208) | 0;
                if ((A | 0) >= (e[V >> 2] | 0)) e[V >> 2] = A + 1;
                if ((e[k >> 2] | 0) > 0) {
                    m = 0;
                    do {
                        M = e[(q + ((A * 3208) | 0) + 1092 + (m << 2)) >> 2] | 0;
                        b = e[B >> 2] | 0;
                        y = u(2840) | 0;
                        e[(b + 1568 + (M << 2)) >> 2] = y;
                        d(y | 0, e[(L + (M << 5) + 12) >> 2] | 0, 2840) | 0;
                        n = (b + 20) | 0;
                        if ((e[n >> 2] | 0) <= (M | 0)) e[n >> 2] = M + 1;
                        z = (y + 8) | 0;
                        e[z >> 2] = e[(L + (M << 5) + 8) >> 2];
                        P = (b + 1312 + (M << 2)) | 0;
                        e[P >> 2] = e[(L + (M << 5)) >> 2];
                        ...
                        do
                            if (!(e[C >> 2] | 0)) {
                                if (n) {
                                    ...
                                    do {
                                        s = (o + (i << 2)) | 0;
                                        if (e[(n + (i << 4)) >> 2] | 0) e[s >> 2] = e[s >> 2] | 1;
                                        if (e[(n + (i << 4) + 4) >> 2] | 0) e[s >> 2] = e[s >> 2] | 2;
                                        if (e[(n + (i << 4) + 8) >> 2] | 0) e[s >> 2] = e[s >> 2] | 4;
                                        if (e[(n + (i << 4) + 12) >> 2] | 0) e[s >> 2] = e[s >> 2] | 8;
                                        i = (i + 1) | 0;
                                        s = e[I >> 2] | 0;
                                    } while ((i | 0) < (s | 0));
                                }
                        ...
                        O = O > R ? R : O;
                        E = +(S | 0);
                        e[((e[(b + 1056 + (A << 2)) >> 2] | 0) + 1116) >> 2] = ~~(E * (O / R));
                        s = e[(L + (M << 5) + 4) >> 2] | 0;
                        do
                            if ((s | 0) == 2) O = 250;
                            else if ((s | 0) == 1) {
                                O = +(e[((e[C >> 2] | 0) == 0 ? (b + 2968) | 0 : (b + 2996) | 0) >> 2] | 0) * 1e3;
                                if (!(O > R)) break;
                                O = R;
                            }
                        while (0);
            ...
            if ((l | 0) > 0) e[(D + 16) >> 2] = l;
                ...
                w = ~~a;
                a = a - +(w | 0);
                p = e[((e[(p + 3396) >> 2] | 0) + 4) >> 2] | 0;
                if (!p) y = -1;
                else y = ~~((+t[(p + ((w + 1) << 3)) >> 3] * a + +t[(p + (w << 3)) >> 3] * (1 - a)) * +(e[H >> 2] | 0));
                e[(D + 16) >> 2] = y;
            }
            p = (_ + 3424) | 0;
            e[(D + 20) >> 2] = e[p >> 2];
            ...
            e[(_ + 3364) >> 2] = e[p >> 2];
            e[(_ + 3368) >> 2] = e[w >> 2];
            e[(_ + 3372) >> 2] = e[(_ + 3444) >> 2];
            t[(_ + 3376) >> 3] = +t[(_ + 3448) >> 3];
            t[(_ + 3384) >> 3] = +t[(_ + 3432) >> 3];
            c = 0;
            return c | 0;
        }
        function dt(n, a, o, t) {
            ...
            if ((o | 0) >= 1) {
                i = e[(n + 28) >> 2] | 0;
                t = t + 1e-7;
                t = !(t >= 1) ? t : 0.9998999834060669;
                r[(i + 3416) >> 2] = t;
                s = wt(a, o, t, 0, (i + 3400) | 0) | 0;
                e[(i + 3396) >> 2] = s;
                if (!s) i = -130;
                else {
                    pt(n, a, o);
        ...
        function ie(n, i, o, t, l, u) {
            ...
            a = ~~i;
            s = i - +(a | 0);
            f = e[((e[(n + 28) >> 2] | 0) + 2852 + (o << 2)) >> 2] | 0;
            i = 1 - s;
            n = (a + 1) | 0;
            r[(f + 12) >> 2] = +(e[(t + ((n * 20) | 0)) >> 2] | 0) * s + +(e[(t + ((a * 20) | 0)) >> 2] | 0) * i;
            r[(f + 16) >> 2] = +(e[(t + ((n * 20) | 0) + 4) >> 2] | 0) * s + +(e[(t + ((a * 20) | 0) + 4) >> 2] | 0) * i;
            r[(f + 20) >> 2] = +(e[(t + ((n * 20) | 0) + 8) >> 2] | 0) * s + +(e[(t + ((a * 20) | 0) + 8) >> 2] | 0) * i;
            r[(f + 24) >> 2] = +r[(t + ((n * 20) | 0) + 12) >> 2] * s + +r[(t + ((a * 20) | 0) + 12) >> 2] * i;
            r[(f + 28) >> 2] = +r[(t + ((n * 20) | 0) + 16) >> 2] * s + +r[(t + ((a * 20) | 0) + 16) >> 2] * i;
            r[(f + 496) >> 2] = +(e[(l + (n << 2)) >> 2] | 0) * s + +(e[(l + (a << 2)) >> 2] | 0) * i;
            o = 0;
            do {
                r[(f + 36 + (o << 2)) >> 2] = +(e[(u + ((n * 68) | 0) + (o << 2)) >> 2] | 0) * s + +(e[(u + ((a * 68) | 0) + (o << 2)) >> 2] | 0) * i;
                o = (o + 1) | 0;
            } while ((o | 0) != 17);
            return;
        }
        function ee(i, n, l, d, a, c, s) {
            i = i | 0;
            n = +n;
            l = l | 0;
            d = d | 0;
            ...
            f = ~~n;
            t = n - +(f | 0);
            o = e[((e[(i + 28) >> 2] | 0) + 2852 + (l << 2)) >> 2] | 0;
            n = 1 - t;
            u = (f + 1) | 0;
            r[(o + 108) >> 2] = +(e[(d + (u << 2)) >> 2] | 0) * t + +(e[(d + (f << 2)) >> 2] | 0) * n;
            e[(o + 120) >> 2] = e[(c + ((l * 12) | 0)) >> 2];
            e[(o + 124) >> 2] = e[(c + ((l * 12) | 0) + 4) >> 2];
            e[(o + 128) >> 2] = e[(c + ((l * 12) | 0) + 8) >> 2];
            i = 0;
            do {
                r[(o + 132 + (i << 2)) >> 2] = +(e[(a + ((u * 204) | 0) + (i << 2)) >> 2] | 0) * t + +(e[(a + ((f * 204) | 0) + (i << 2)) >> 2] | 0) * n;
                i = (i + 1) | 0;
            } while ((i | 0) != 17);
            i = 0;
            do {
                r[(o + 200 + (i << 2)) >> 2] = +(e[(a + ((u * 204) | 0) + 68 + (i << 2)) >> 2] | 0) * t + +(e[(a + ((f * 204) | 0) + 68 + (i << 2)) >> 2] | 0) * n;
                i = (i + 1) | 0;
            } while ((i | 0) != 17);
            i = 0;
            do {
                r[(o + 268 + (i << 2)) >> 2] = +(e[(a + ((u * 204) | 0) + 136 + (i << 2)) >> 2] | 0) * t + +(e[(a + ((f * 204) | 0) + 136 + (i << 2)) >> 2] | 0) * n;
                i = (i + 1) | 0;
            } while ((i | 0) != 17);
            t = +r[(o + 132) >> 2];
            n = t + 6;
            ...
            do {
                t = +r[(o + 268 + (i << 2)) >> 2] + s;
                r[(o + 268 + (i << 2)) >> 2] = t < n ? n : t;
                i = (i + 1) | 0;
            } while ((i | 0) != 17);
            return;
        }
        function wt(c, u, a, i, d) {
            c = c | 0;
            u = u | 0;
            a = +a;
            i = i | 0;
            ...
            e: do
                if (!i) {
                    ...
                    while (1) {
                        ...
                        s = e[(r + 12) >> 2] | 0;
                        if (
                            (((((s | 0) == -1) | ((s | 0) == (c | 0)) ? (e[(r + 16) >> 2] | 0) <= (u | 0) : 0) ? (e[(r + 20) >> 2] | 0) >= (u | 0) : 0) ? ((f = e[r >> 2] | 0), (l = e[(r + 8) >> 2] | 0), (h = +t[l >> 3]), !(h > a)) : 0)
                                ? !(+t[(l + (f << 3)) >> 3] < a)
                                : 0
                        ) {
                            s = f;
                    ...
                    while (1) {
                        ...
                        l = e[(r + 12) >> 2] | 0;
                        if (
                            (((((l | 0) == -1) | ((l | 0) == (c | 0)) ? (e[(r + 16) >> 2] | 0) <= (u | 0) : 0) ? (e[(r + 20) >> 2] | 0) >= (u | 0) : 0) ? ((s = e[r >> 2] | 0), (n = e[(r + 4) >> 2] | 0), (o = +t[n >> 3]), !(a < o)) : 0)
                                ? !(a > +t[(n + (s << 3)) >> 3])
                                : 0
                        )
                            break e;
            ...
            while (0);
            if ((r | 0) == (s | 0)) o = +(s | 0) + -0.001;
            else {
                o = +t[(n + (r << 3)) >> 3];
                o = (a - o) / (+t[(n + ((r + 1) << 3)) >> 3] - o) + +(r | 0);
            }
            t[d >> 3] = o;
            r = e[f >> 2] | 0;
            return r | 0;
        ...
        function pt(o, n, a) {
            ...
            if (!(e[(r + 3488) >> 2] | 0)) {
                ...
                f = 1 - s;
                o = (a + 1) | 0;
                t[(r + 3480) >> 3] = +t[(n + (o << 3)) >> 3] * s + +t[(n + (a << 3)) >> 3] * f;
            } else {
                o = (a + 1) | 0;
                f = 1 - s;
            }
            n = e[(l + 112) >> 2] | 0;
            t[(r + 3496) >> 3] = +(e[(n + (o << 2)) >> 2] | 0) * s + +(e[(n + (a << 2)) >> 2] | 0) * f;
            n = e[(l + 116) >> 2] | 0;
            t[(r + 3504) >> 3] = +(e[(n + (o << 2)) >> 2] | 0) * s + +(e[(n + (a << 2)) >> 2] | 0) * f;
            t[(r + 3512) >> 3] = -6;
            t[(r + 3520) >> 3] = i;
            t[(r + 3528) >> 3] = i;
            t[(r + 3536) >> 3] = i;
        ...
        function mt(l, i, t, n, s, f) {
            ...
            o = a ? n : 0;
            a = a ? f : 0;
            c = e[(520336 + (e[(i + (o << 2)) >> 2] << 2)) >> 2] | 0;
            m = e[(520336 + (e[(i + (a << 2)) >> 2] << 2)) >> 2] | 0;
            u = e[(t + (s << 2)) >> 2] | 0;
            o = e[(t + (o << 2)) >> 2] | 0;
            a = e[(t + (a << 2)) >> 2] | 0;
            i = ((u | 0) / 4) | 0;
            ...
            if ((a | 0) > 1) {
                ...
                do {
                    s = (s + -1) | 0;
                    c = (l + (n << 2)) | 0;
                    r[c >> 2] = +r[c >> 2] * +r[(m + (s << 2)) >> 2];
                    n = (n + 1) | 0;
                } while ((n | 0) < (d | 0));
                n = i ? d : t;
            }
            if ((u | 0) <= (n | 0)) return;
            w((l + (n << 2)) | 0, 0, ((u - n) << 2) | 0) | 0;
            return;
        }
        function ht(n, w, p) {
            n = n | 0;
            ...
            f = (r + 400) | 0;
            do {
                t = ((e[a >> 2] | 0) + (e[l >> 2] | 0) + (e[s >> 2] | 0)) | 0;
                if (t) {
                    m = M(e[o >> 2] | 0, t) | 0;
                    e[o >> 2] = m;
                    t = e[l >> 2] | 0;
                    c = e[a >> 2] | 0;
                    d((m + t) | 0, e[n >> 2] | 0, c | 0) | 0;
                    t = (c + t) | 0;
                    e[l >> 2] = t;
                    c = e[s >> 2] | 0;
                    d((m + t) | 0, e[f >> 2] | 0, c | 0) | 0;
                    e[l >> 2] = c + t;
                }
            } while ((De(r, n) | 0) != 0);
            i = h;
            ...
            do {
                ...
                if (Ce(o, s) | 0)
                    do {
                        ...
                        if (Pe(r, l) | 0)
                            do {
                                i = ((e[u >> 2] | 0) + (e[a >> 2] | 0) + (e[c >> 2] | 0)) | 0;
                                if (i) {
                                    f = M(e[h >> 2] | 0, i) | 0;
                                    e[h >> 2] = f;
                                    i = e[a >> 2] | 0;
                                    n = e[u >> 2] | 0;
                                    d((f + i) | 0, e[w >> 2] | 0, n | 0) | 0;
                                    i = (n + i) | 0;
                                    e[a >> 2] = i;
                                    n = e[c >> 2] | 0;
                                    d((f + i) | 0, e[m >> 2] | 0, n | 0) | 0;
                                    e[a >> 2] = n + i;
                                }
                            } while ((Pe(r, l) | 0) != 0);
                    } while ((Ce(o, s) | 0) != 0);
        ...
        function Z(s, r, h, v) {
                                ...
                                e: do
                                    if ((r | 0) > 1) {
                                        ...
                                        while (1) {
                                            l = (t + M) | 0;
                                            w = (a + -2) | 0;
                                            t = (t + (0 - ((e[(E + (w << 2)) >> 2] | 0) + h))) | 0;
                                            if ((y[v & 15](u, t) | 0) > -1 ? (y[v & 15](u, l) | 0) > -1 : 0) {
                                                S = m;
                                                break;
                                            }
                                            S = (m + 1) | 0;
                                        ...
                                        if ((S | 0) >= 2 ? ((_ = (c + (S << 2)) | 0), (e[_ >> 2] = k), !R) : 0) {
                                            m = h;
                                            a = k;
                                            while (1) {
                                                t = m >>> 0 > 256 ? 256 : m;
                            ...
                            e: do
                                if ((r | 0) > 1) {
                                    ...
                                    while (1) {
                                        u = (t + M) | 0;
                                        l = (a + -2) | 0;
                                        t = (t + (0 - ((e[(E + (l << 2)) >> 2] | 0) + h))) | 0;
                                        if ((y[v & 15](S, t) | 0) > -1 ? (y[v & 15](S, u) | 0) > -1 : 0) {
                                            p = w;
                                            break;
                                        }
                                        p = (w + 1) | 0;
                                    ...
                                    if ((p | 0) >= 2 ? ((b = (c + (p << 2)) | 0), (e[b >> 2] = k), !R) : 0) {
                                        m = h;
                                        a = k;
                                        while (1) {
                                            w = m >>> 0 > 256 ? 256 : m;
            ...
            while (1) {
                if ((u | 0) >= 2) {
                    _ = t >>> 30;
                    k = (u + -2) | 0;
                    b = (((t << 1) & 2147483646) | (_ << 31)) ^ 3;
                    c = (_ | (o << 2)) >>> 1;
                    $((l + (0 - ((e[(E + (k << 2)) >> 2] | 0) + h))) | 0, h, v, b, c, (u + -1) | 0, 1, E);
                    _ = (c << 1) | (_ & 1);
                    b = (b << 1) | 1;
                    c = (l + M) | 0;
                    $(c, h, v, b, _, k, 1, E);
                ...
                o = o >>> n;
                u = (r + u) | 0;
                if (((o | 0) == 0) & (((t | 0) == 1) & ((u | 0) == 1))) break;
                else l = (l + M) | 0;
            }
            i = F;
            return;
        }
        function $(o, u, h, t, r, f, s, v) {
            o = o | 0;
            u = u | 0;
            h = h | 0;
            t = t | 0;
            ...
            S = (0 - u) | 0;
            e: do
                if (((r | 0) != 0) | ((t | 0) != 1) ? ((n = (o + (0 - (e[(v + (f << 2)) >> 2] | 0))) | 0), (y[h & 15](n, o) | 0) >= 1) : 0) {
                    l = n;
                    a = r;
                    n = 1;
                    while (1) {
                        if (((s | 0) == 0) & ((f | 0) > 1)) {
                            r = e[(v + ((f + -2) << 2)) >> 2] | 0;
                            if ((y[h & 15]((o + S) | 0, l) | 0) > -1) break e;
                            if ((y[h & 15]((o + (0 - (r + u))) | 0, l) | 0) > -1) break e;
                        }
                        w = (n + 1) | 0;
                        e[(m + (n << 2)) >> 2] = l;
                        r = (t + -1) | 0;
            ...
            e: do
                if ((n | 0) >= 2 ? ((b = (m + (n << 2)) | 0), (e[b >> 2] = _), (u | 0) != 0) : 0) {
                    t = u;
                    s = _;
                    while (1) {
                        a = t >>> 0 > 256 ? 256 : t;
            ...
            e: do
                if ((f | 0) > 1) {
                    ...
                    while (1) {
                        o = (t + S) | 0;
                        n = (f + -2) | 0;
                        t = (t + (0 - ((e[(v + (n << 2)) >> 2] | 0) + u))) | 0;
                        if ((y[h & 15](a, t) | 0) > -1 ? (y[h & 15](a, o) | 0) > -1 : 0) {
                            s = r;
                            break;
                        }
                        s = (r + 1) | 0;
                    ...
                    if ((s | 0) >= 2 ? ((g = (p + (s << 2)) | 0), (e[g >> 2] = _), (u | 0) != 0) : 0) {
                        a = _;
                        while (1) {
                            f = u >>> 0 > 256 ? 256 : u;
                            t = e[p >> 2] | 0;
        ...
        function F(r) {
            ...
            i = e[(p + 4) >> 2] | 0;
            n = i & 2146435072;
            if ((n >>> 0 > 1126170624) | (((n | 0) == 1126170624) & (0 > 0))) return +r;
            i = (i | 0) < 0;
            r = i ? r + -4503599627370496 + 4503599627370496 : r + 4503599627370496 + -4503599627370496;
            if (!(r == 0)) return +r;
            r = i ? -0 : 0;
            return +r;
        }
        function Ve(i) {
            ...
            var t = 0;
            t = ((r[p >> 2] = i), e[p >> 2] | 0);
            if ((t & 2130706432) >>> 0 > 1249902592) return +i;
            t = (t | 0) < 0;
            i = t ? i + -8388608 + 8388608 : i + 8388608 + -8388608;
            if (!(i == 0)) return +i;
            i = t ? -0 : 0;
            return +i;
        }
        ...
        function Vr() {
            var i = 0,
                ...
                t = 0;
            r = 553040;
            r = Gi(e[r >> 2] | 0, e[(r + 4) >> 2] | 0, 1284865837, 1481765933) | 0;
            r = N(r | 0, l | 0, 1, 0) | 0;
            i = l;
            t = 553040;
            e[t >> 2] = r;
        ...
        function u(n) {
                ...
                if (n >>> 0 < 245) {
                    ...
                    if (u >>> 0 > d >>> 0) {
                        ...
                        if (n) {
                            ...
                            r = r >>> i;
                            a = (r >>> 1) & 1;
                            a = e[(553352 + (((b | v | t | i | a) + (r >>> a)) << 2)) >> 2] | 0;
                            r = ((e[(a + 4) >> 2] & -8) - u) | 0;
                            i = a;
                            while (1) {
                                l = e[(i + 16) >> 2] | 0;
                            ...
                            do
                                if (f) {
                                    ...
                                    if ((p | 0) == (e[r >> 2] | 0)) {
                                        e[r >> 2] = c;
                                        if (!c) {
                                            e[138263] = e[138263] & ~(1 << i);
                                            break;
                                        }
                                    } else {
                                        if (f >>> 0 < (e[138266] | 0) >>> 0) o();
                                        i = (f + 16) | 0;
                    ...
                    if (p) {
                        ...
                        if ((t | 0) == 86) {
                            if (((r | 0) == 0) & ((n | 0) == 0)) {
                                ...
                                n = n >>> u;
                                r = (n >>> 1) & 1;
                                r = e[(553352 + (((g | m | _ | u | r) + (n >>> r)) << 2)) >> 2] | 0;
                                n = 0;
                            }
                            if (!r) {
                                m = f;
                        ...
                        if ((u | 0) != 0 ? m >>> 0 < (((e[138264] | 0) - w) | 0) >>> 0 : 0) {
                            n = e[138266] | 0;
                            if (u >>> 0 < n >>> 0) o();
                            g = (u + w) | 0;
                            if (u >>> 0 >= g >>> 0) o();
            ...
            n = e[138372] | 0;
            if ((n | 0) != 0 ? ((M = e[138370] | 0), (b = (M + g) | 0), (b >>> 0 <= M >>> 0) | (b >>> 0 > n >>> 0)) : 0) {
                t = 0;
                return t | 0;
            }
            e: do
                if (!(e[138373] & 4)) {
                    ...
                    r: do
                        if (n) {
                            ...
                            while (1) {
                                f = e[r >> 2] | 0;
                                if (f >>> 0 <= n >>> 0 ? ((C = (r + 4) | 0), ((f + (e[C >> 2] | 0)) | 0) >>> 0 > n >>> 0) : 0) {
                                    a = r;
                                    n = C;
                                    break;
                                }
                    ...
                    do
                        if ((t | 0) == 174) {
                            ...
                            if ((a | 0) != (-1 | 0)) {
                                ...
                                r = (f + -1) | 0;
                                if (!(r & n)) f = g;
                                else f = (g - n + ((r + n) & (0 - f))) | 0;
                                n = e[138370] | 0;
                                r = (n + f) | 0;
                                if ((f >>> 0 > E >>> 0) & (f >>> 0 < 2147483647)) {
                                    b = e[138372] | 0;
                                    if ((b | 0) != 0 ? (r >>> 0 <= n >>> 0) | (r >>> 0 > b >>> 0) : 0) {
                                        n = 0;
                                        break;
                                    }
                                    r = x(f | 0) | 0;
                    ...
                    r: do
                        if ((t | 0) == 184) {
                            a = (0 - f) | 0;
                            do
                                if ((S >>> 0 > f >>> 0) & ((f >>> 0 < 2147483647) & ((r | 0) != (-1 | 0))) ? ((v = e[138382] | 0), (v = (d - f + v) & (0 - v)), v >>> 0 < 2147483647) : 0)
                                    if ((x(v | 0) | 0) == (-1 | 0)) {
                                        x(a | 0) | 0;
                                        break r;
                                    } else {
            ...
            while (0);
            if (
                (((t | 0) == 191 ? g >>> 0 < 2147483647 : 0) ? ((h = x(g | 0) | 0), (O = x(0) | 0), (h >>> 0 < O >>> 0) & (((h | 0) != (-1 | 0)) & ((O | 0) != (-1 | 0)))) : 0)
                    ? ((D = (O - h) | 0), (L = D >>> 0 > ((E + 40) | 0) >>> 0), L)
                    : 0
            ) {
                n = L ? D : n;
                t = 194;
            ...
            if ((t | 0) == 194) {
                f = ((e[138370] | 0) + n) | 0;
                e[138370] = f;
                if (f >>> 0 > (e[138371] | 0) >>> 0) e[138371] = f;
                m = e[138268] | 0;
                e: do
                    if (m) {
                        c = 553496;
                        ...
                        if (((t | 0) == 204 ? ((e[(z + 12) >> 2] & 8) | 0) == 0 : 0) ? (m >>> 0 < h >>> 0) & (m >>> 0 >= I >>> 0) : 0) {
                            e[U >> 2] = H + n;
                            t = ((e[138265] | 0) + n) | 0;
                            v = (m + 8) | 0;
                            v = ((v & 7) | 0) == 0 ? 0 : (0 - v) & 7;
                                        ...
                                        if (((r & 3) | 0) == 1) {
                                            ...
                                            i: do
                                                if (r >>> 0 >= 256) {
                                                    ...
                                                    do
                                                        if ((i | 0) != (e[r >> 2] | 0)) {
                                                            if (l >>> 0 < (e[138266] | 0) >>> 0) o();
                                                            f = (l + 16) | 0;
                                                            if ((e[f >> 2] | 0) == (i | 0)) e[f >> 2] = y;
                                                            else e[(l + 20) >> 2] = y;
                                                            if (!y) break i;
                                                        } else {
                                                            e[r >> 2] = y;
                                                            if (y) break;
                                                            e[138263] = e[138263] & ~(1 << f);
                                                            break i;
                                                        }
                                                    while (0);
                                                    r = e[138266] | 0;
                                                    ...
                                                    do
                                                        if ((a | 0) != (r | 0)) {
                                                            if (a >>> 0 < f >>> 0) o();
                                                            if ((e[(a + 12) >> 2] | 0) == (i | 0)) break;
                                                            o();
                                                        }
                                                    while (0);
                                                    if ((s | 0) == (a | 0)) {
                                                        e[138262] = e[138262] & ~(1 << c);
                                                        break;
                                                    }
                                                    do
                                                        if ((s | 0) == (r | 0)) P = (s + 8) | 0;
                        ...
                        while (1) {
                            r = e[a >> 2] | 0;
                            if (r >>> 0 <= m >>> 0 ? ((i = e[(a + 4) >> 2] | 0), (s = (r + i) | 0), s >>> 0 > m >>> 0) : 0) break;
                            a = e[(a + 8) >> 2] | 0;
                        }
                        f = (r + (i + -39)) | 0;
                ...
                if (!(i & 1)) {
                    ...
                    if (s) {
                        ...
                        if ((f | 0) == (e[i >> 2] | 0)) {
                            e[i >> 2] = c;
                            if (!c) {
                                e[138263] = e[138263] & ~(1 << r);
                                a = f;
                                u = p;
                                break;
                            }
                        } else {
                            if (s >>> 0 < (e[138266] | 0) >>> 0) o();
                            r = (s + 16) | 0;
            ...
            if (!(i & 2)) {
                ...
                do
                    if (i >>> 0 >= 256) {
                        ...
                        if ((n | 0) == (t | 0)) {
                            e[138262] = e[138262] & ~(1 << s);
                            break;
                        }
                        if ((n | 0) != (r | 0)) {
                            if (n >>> 0 < (e[138266] | 0) >>> 0) o();
                            i = (n + 8) | 0;
                            if ((e[i >> 2] | 0) == (v | 0)) S = i;
                            else o();
                        } else S = (n + 8) | 0;
        ...
        function Cr(t, a) {
            ...
            if (!r) {
                ...
                if (f >>> 0 >= ((a + 4) | 0) >>> 0 ? ((f - a) | 0) >>> 0 <= (e[138382] << 1) >>> 0 : 0) {
                    i = t;
                    return i | 0;
                }
                i = 0;
        ...
        function N(r, i, e, t) {
            ...
            t = t | 0;
            e = (r + e) >>> 0;
            return ((l = (i + t + ((e >>> 0 < r >>> 0) | 0)) >>> 0), e | 0) | 0;
        }
        function T(i, r, e) {
            i = i | 0;
            r = r | 0;
        ...
        function d(r, i, t) {
            ...
            t = t | 0;
            var n = 0;
            if ((t | 0) >= 4096) return hr(r | 0, i | 0, t | 0) | 0;
            n = r | 0;
            if ((r & 3) == (i & 3)) {
                while (r & 3) {
                    if (!t) return n | 0;
        ...
        function Ji(e, r) {
            ...
            r = r >>> 16;
            e = f(r, o) | 0;
            return ((l = ((i >>> 16) + (f(r, n) | 0) + ((((i & 65535) + e) | 0) >>> 16)) | 0), ((i + e) << 16) | (t & 65535) | 0) | 0;
        }
        function Qt(i, e, s, r) {
            i = i | 0;
            e = e | 0;
            ...
            e = n ^ a;
            i = t ^ o;
            return O((re(u, f, O(n ^ s, t ^ r, n, t) | 0, l, 0) | 0) ^ e, l ^ i, e, i) | 0;
        }
        function $t(t, r, f, n) {
            t = t | 0;
            r = r | 0;
            ...
            d = (n >> 31) | (((n | 0) < 0 ? -1 : 0) << 1);
            c = (((n | 0) < 0 ? -1 : 0) >> 31) | (((n | 0) < 0 ? -1 : 0) << 1);
            r = O(a ^ t, o ^ r, a, o) | 0;
            t = l;
            re(r, t, O(d ^ f, c ^ n, d, c) | 0, l, s) | 0;
            t = O(e[s >> 2] ^ a, e[(s + 4) >> 2] ^ o, a, o) | 0;
            r = l;
            i = u;
            return ((l = r), t) | 0;
        }
        function Gi(r, i, e, t) {
            ...
            r = Ji(n, o) | 0;
            e = l;
            return ((l = ((f(i, o) | 0) + (f(t, n) | 0) + e) | (e & 0)), r | 0 | 0) | 0;
        }
        function rn(e, r, i, t) {
            e = e | 0;
            r = r | 0;
        ...
        function tn(t, n, o, a) {
            ...
            re(t, n, o, a, r) | 0;
            i = s;
            return ((l = e[(r + 4) >> 2] | 0), e[r >> 2] | 0) | 0;
        }
        function re(f, d, h, w, n) {
            f = f | 0;
            d = d | 0;
            h = h | 0;
            w = w | 0;
            ...
            do
                if (o) {
                    ...
                    if (u & o) {
                        ...
                        o = d >> 31;
                        a = t;
                        u = (((i - 1) >> 31) & (r >>> (d >>> 0))) | (((r << i) | (s >>> (t >>> 0))) & o);
                        o = o & (r >>> (t >>> 0));
                        c = (s << m) & f;
                        t = (((r << m) | (s >>> (d >>> 0))) & f) | ((s << i) & ((t - 33) >> 31));
                        break;
                    }
                    if (n) {
                        e[n >> 2] = u & s;
            ...
            if (!a) {
                ...
                do {
                    ...
                    w = (s >> 31) | (((s | 0) < 0 ? -1 : 0) << 1);
                    t = w & 1;
                    u = O(m, p, w & r, ((((s | 0) < 0 ? -1 : 0) >> 31) | (((s | 0) < 0 ? -1 : 0) << 1)) & i) | 0;
                    o = l;
                    a = (a - 1) | 0;
                } while ((a | 0) != 0);
                i = h;
            ...
            i = ((c | 0) >>> 31) | ((i | h) << 1) | (((h << 1) | (c >>> 31)) & 0) | a;
            r = (((c << 1) | (0 >>> 31)) & -2) | t;
            return ((l = i), r) | 0;
        }
        function Li(e, r, i, t, n) {
            e = e | 0;
            r = r | 0;
            i = i | 0;
            t = t | 0;
            n = n | 0;
            return de[e & 3](r | 0, i | 0, t | 0, n | 0) | 0;
        }
        function Di(e, r) {
            e = e | 0;
            r = r | 0;
        ...
        function wi(e, r, i, t, n, o, a, s, f) {
            ...
            s = s | 0;
            f = f | 0;
            return qe[e & 3](r | 0, i | 0, t | 0, n | 0, o | 0, a | 0, s | 0, f | 0) | 0;
        }
        function li(e, r, i) {
            e = e | 0;
            r = r | 0;
            i = i | 0;
            return y[e & 15](r | 0, i | 0) | 0;
        }
        function Mr(e, r, i, t, n, o) {
            e = e | 0;
            r = r | 0;
            i = i | 0;
            t = t | 0;
            n = n | 0;
            o = o | 0;
            return Se[e & 7](r | 0, i | 0, t | 0, n | 0, o | 0) | 0;
        }
        function gr(e, r, i, t) {
            e = e | 0;
            r = r | 0;
        ...
        var de = [gr, $r, Pr, Lr];
        var R = [we, Zr, Jr, di, Ci, Ii, we, we];
        var ue = [Ae, Xr, xi, Ae];
        var ke = [ur, hi];
        var ye = [ut, ui];
        var qe = [Me, qi, Yi, Me];
        var y = [z, Kr, Gr, Qr, ci, mi, Hi, Ui, ei, Bi, nt, z, z, z, z, z];
        var Se = [oe, zi, Vi, ji, Wi, Xi, oe, oe];
        return {
            _memmove: B,
            _strlen: V,
            _strcat: Ie,
            ...
            _i64Add: N,
            _encoder_clear: et,
            _encoder_transfer_data: pi,
            _encoder_data_len: ki,
            _memset: w,
            _malloc: u,
            _memcpy: d,
            _encoder_init: ht,
            ...
            _bitshift64Shl: Be,
            _strcpy: le,
            _encoder_analysis_buffer: Zi,
            runPostSets: Nr,
            stackAlloc: Ar,
            stackSave: Or,
            stackRestore: Dr,
            establishStackSpace: oi,
            setThrew: fi,
            setTempRet0: Ei,
            getTempRet0: _i,
            dynCall_iiiii: Li,
    ...
    var i64Math = (function () {
        ...
        e.math.Long.fromNumber = function (r) {
            if (isNaN(r) || !isFinite(r)) {
                ...
                return new e.math.Long(r % e.math.Long.TWO_PWR_32_DBL_ | 0, (r / e.math.Long.TWO_PWR_32_DBL_) | 0);
            }
        };
        ...
        function B(v, a, e) {
            ...
            while (i.t < n) i[i.t++] = 0;
            while (--u >= 0) {
                var c = e[--f] == h ? this.DM : Math.floor(e[f] * E + (e[f - 1] + S) * _);
        ...
        function X(e) {
            ...
            for (var i = 0; i < this.m.t; ++i) {
                var r = e[i] & 32767;
                var t = (r * this.mpl + (((r * this.mph + (e[i] >> 15) * this.mpl) & this.um) << 15)) & e.DM;
                r = i + this.m.t;
    ...
    Module["callMain"] = Module.callMain = function g(i) {
    ...
    var Encoder = function (e, r, i) {
        this.numChannels = r;
        this.oggBuffers = [];
        this.encoder = encoder_init(this.numChannels, e, i);
    };
    Encoder.prototype.encode = function (r) {
        var i = r[0].length;
        var t = encoder_analysis_buffer(this.encoder, i) >> 2;
        for (var e = 0; e < this.numChannels; ++e) HEAPF32.set(r[e], HEAPU32[t + e] >> 2);
        this.process(i);
    };
    Encoder.prototype.finish = function (e) {
        this.process(0);
        var r = new Blob(this.oggBuffers, { type: e || "audio/ogg" });
        this.cleanup();
        return r;
    };
    ...
    Encoder.prototype.process = function (i) {
        encoder_process(this.encoder, i);
        var e = encoder_data_len(this.encoder);
        if (e > 0) {
            var r = encoder_transfer_data(this.encoder);
            this.oggBuffers.push(new Uint8Array(HEAPU8.subarray(r, r + e)));
        }
    };
...
var sampleRate = 44100,
    ...
    bufferCount = 0;
function error(e) {
    self.postMessage({ command: "error", message: "ogg: " + e });
}
function init(e) {
...
function start(e) {
    ...
    else encoder = new OggVorbisEncoder(sampleRate, numChannels, options.ogg.quality);
}
function record(e) {
...
function finish() {
    ...
    self.postMessage({ command: "complete", blob: encoder.finish(options.ogg.mimeType) });
    cleanup();
}
function cleanup() {
