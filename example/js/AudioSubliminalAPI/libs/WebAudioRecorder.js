...
// instance methods
    extend(WebAudioRecorder.prototype, {
        ...
        setOptions: function (options) {
            if (this.isRecording())
                ...
                this.workers.forEach((worker) => {
                    worker.postMessage({command: "options", options: this.options});
                });
            }
        },
        ...
        initWorker: function () {
            ...
            this.workers = [new Worker(this.workerDir + WORKER_FILE.wav), new Worker(this.workerDir + WORKER_FILE.mp3)];
